...
MATTER_BUILD_OPTION=qcc74x-qcc743dk-light-thread
...
if [[ "$MATTER_REPO_PATH" == "" ]]; then
    export QCC74X_SDK_TOOLCHAIN="/home/matter_toolchain/toolchain/t-head-riscv/gcc_t-head_v2.6.1/bin"
fi
if [[ "$ZAP_INSTALL_PATH" == "" ]]; then
    export ZAP_INSTALL_PATH="/home/tools/zap/zap-linux-x64"
fi
