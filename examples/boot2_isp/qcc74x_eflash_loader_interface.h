#ifndef __QCC74x_EFLASH_LOADER_INTERFACE_H__
#define __QCC74x_EFLASH_LOADER_INTERFACE_H__
...
typedef enum tag_eflash_loader_if_type_t {
    ...
    QCC74x_EFLASH_LOADER_IF_UART = 0x0,
    QCC74x_EFLASH_LOADER_IF_JLINK,
    QCC74x_EFLASH_LOADER_IF_SDIO,
    QCC74x_EFLASH_LOADER_IF_USB,
    QCC74x_EFLASH_LOADER_IF_ALL,
...
eflash_loader_if_cfg_t *qcc74x_eflash_loader_if_set(eflash_loader_if_type_t type);
int32_t qcc74x_eflash_loader_if_init();
int32_t qcc74x_eflash_loader_if_handshake_poll(uint32_t timeout);
uint32_t *qcc74x_eflash_loader_if_read(uint32_t *read_len);
int32_t qcc74x_eflash_loader_if_write(uint32_t *data, uint32_t len);
int32_t qcc74x_eflash_loader_if_wait_tx_idle(uint32_t timeout);
int32_t qcc74x_eflash_loader_if_deinit();
int32_t qcc74x_eflash_loader_main(void);
