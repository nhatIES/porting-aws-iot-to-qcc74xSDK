...
static void qcc74x_lp_set_aon_io(int pin, int trigMode, int res_mode)
{
...
static void qcc74x_lp_set_pds_io(int pin, int trigMode, int res_mode)
{
    /* set pin's GLB_GPIO_FUNC_Type as GPIO_FUN_GPIO */
    GLB_GPIO_Cfg_Type gpio_cfg;
    uint8_t pu, pd;
...
int main(void)
{
    ...
    qcc74x_lp_set_pds_io(0, PDS_GPIO_INT_SYNC_HIGH_LEVEL, QCC74x_LP_IO_RES_PULL_DOWN);
    qcc74x_lp_set_aon_io(19, HBN_GPIO_INT_TRIGGER_SYNC_HIGH_LEVEL, QCC74x_LP_IO_RES_PULL_DOWN);
