...
#if defined(CONFIG_BT_MESH_MODEL)
static void example_handle_gen_onoff_msg(qcc74x_ble_mesh_model_t *model,
										 qcc74x_ble_mesh_msg_ctx_t *ctx,
										 qcc74x_ble_mesh_server_recv_gen_onoff_set_t *set)
{
	qcc74x_ble_mesh_gen_onoff_srv_t *srv = model->user_data;

	switch (ctx->recv_op) {
	case QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_GET:
		qcc74x_ble_mesh_server_model_send_msg(model, ctx,
			QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS, sizeof(srv->state.onoff), &srv->state.onoff);
		break;
	...
	case QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK:
		...
		if (ctx->recv_op == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET) {
			qcc74x_ble_mesh_server_model_send_msg(model, ctx,
				QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS, sizeof(srv->state.onoff), &srv->state.onoff);
		}
		qcc74x_ble_mesh_model_publish(model, QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS,
...
static void example_ble_mesh_generic_server_cb(qcc74x_ble_mesh_generic_server_cb_event_t event,
                                               qcc74x_ble_mesh_generic_server_cb_param_t *param)
{
    ...
    case QCC74x_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT:
        printf("QCC74x_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT\n");
        if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK) {
            printf("onoff 0x%02x\n", param->value.state_change.onoff_set.onoff);
            model_gen_cb(param->value.state_change.onoff_set.onoff);
        }
        break;
    case QCC74x_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT:
        printf("QCC74x_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT\n");
        if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_GET) {
    ...
    case QCC74x_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT:
        printf("QCC74x_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT\n");
        if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET ||
            param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK) {
...
static void example_handle_light_lgn_msg(qcc74x_ble_mesh_model_t *model,
										 qcc74x_ble_mesh_msg_ctx_t *ctx,
										 qcc74x_ble_mesh_server_recv_light_lightness_set_t *set)
{
	qcc74x_ble_mesh_light_lightness_srv_t *srv = model->user_data;

	switch (ctx->recv_op) {
	case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_GET:
		qcc74x_ble_mesh_server_model_send_msg(model, ctx,
			QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_STATUS, sizeof(srv->state->lightness_actual), (uint8_t*)&srv->state->lightness_actual);
		break;
	...
	case QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET_UNACK:
		...
		if (ctx->recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_SET) {
			qcc74x_ble_mesh_server_model_send_msg(model, ctx,
				QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_STATUS, sizeof(srv->state->lightness_actual), (uint8_t*)&srv->state->lightness_actual);
		}
		qcc74x_ble_mesh_model_publish(model, QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_STATUS,
...
static void example_ble_mesh_lighting_server_cb(qcc74x_ble_mesh_lighting_server_cb_event_t event,
			qcc74x_ble_mesh_lighting_server_cb_param_t *param)
{
    ...
    case QCC74x_BLE_MESH_LIGHTING_SERVER_STATE_CHANGE_EVT:
        printf("QCC74x_BLE_MESH_LIGHTING_SERVER_STATE_CHANGE_EVT\n");
        ...
        break;
    case QCC74x_BLE_MESH_LIGHTING_SERVER_RECV_GET_MSG_EVT:
        printf("QCC74x_BLE_MESH_LIGHTING_SERVER_RECV_GET_MSG_EVT\n");
        if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LIGHTNESS_GET) {
            qcc74x_ble_mesh_light_lightness_srv_t *srv = param->model->user_data;
            printf("onoff 0x%02x\n", srv->state->lightness_actual);
            example_handle_light_lgn_msg(param->model, &param->ctx, NULL);
        }
		else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_CTL_GET) {
            qcc74x_ble_mesh_light_ctl_srv_t *srv = param->model->user_data;
		...
		else if (param->ctx.recv_op == QCC74x_BLE_MESH_MODEL_OP_LIGHT_HSL_GET) {
            qcc74x_ble_mesh_light_hsl_srv_t *srv = param->model->user_data;
...
#if defined(CONFIG_BT_MESH_MODEL)
#if defined(CONFIG_BT_MESH_MODEL_GEN_SRV)
        qcc74x_ble_mesh_register_generic_server_callback(example_ble_mesh_generic_server_cb);
#endif
#if defined(CONFIG_BT_MESH_MODEL_LIGHT_SRV)
		qcc74x_ble_mesh_register_lighting_server_callback(example_ble_mesh_lighting_server_cb);
#endif
