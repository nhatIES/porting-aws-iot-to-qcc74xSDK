...
int main(void)
{
    ...
    struct qcc74x_dma_channel_lli_transfer_s transfers[3];
    ...
    qcc74x_dma_feature_control(dma0_ch0, DMA_CMD_SET_REDUCE_MODE, 1);
    qcc74x_dma_channel_lli_reload(dma0_ch0, lli, 20, transfers, 1);
    ...
    qcc74x_dma_feature_control(dma0_ch0, DMA_CMD_SET_REDUCE_MODE, 0);
    qcc74x_dma_feature_control(dma0_ch0, DMA_CMD_SET_ADD_MODE, 1);
    ...
    qcc74x_dma_channel_tcint_mask(dma0_ch0, false);
    ...
    qcc74x_dma_feature_control(dma0_ch0, DMA_CMD_SET_ADD_MODE, 0);
    qcc74x_dma_channel_lli_reload(dma0_ch0, lli, 20, transfers, 1);
