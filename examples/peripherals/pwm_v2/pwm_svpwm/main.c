...
void qcc74x_pwm_out(struct foc_svpwm_s *svpwm)
{
...
int main(void)
{
    ...
    while (1) {
        bool key100 = qcc74x_gpio_read(gpio, GPIO_PIN_32);
        bool key10 = qcc74x_gpio_read(gpio, GPIO_PIN_33);
        bool key1 = qcc74x_gpio_read(gpio, GPIO_PIN_34);
