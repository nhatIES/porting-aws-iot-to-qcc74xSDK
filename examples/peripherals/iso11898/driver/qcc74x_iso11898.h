#ifndef _QCC74x_ISO11898_H
#define _QCC74x_ISO11898_H
...
struct qcc74x_iso11898_config_s {
...
struct qcc74x_iso11898_filter_s {
    uint8_t filter_type;
    uint8_t code0;
    uint8_t code1;
    uint8_t code2;
 ...
 * @param [in] config
 */
void qcc74x_iso11898_init(struct qcc74x_device_s *dev, struct qcc74x_iso11898_config_s *config);
 ...
 * @param [in] dev
 */
void qcc74x_iso11898_deinit(struct qcc74x_device_s *dev);
 ...
 * @param [in] dev
 */
void qcc74x_iso11898_abort_send(struct qcc74x_device_s *dev);
 ...
 * @return int8_t
 */
int8_t qcc74x_iso11898_send(struct qcc74x_device_s *dev, struct qcc74x_iso11898_msg_s *msg, uint32_t timeout);
 ...
 * @return int8_t
 */
int8_t qcc74x_iso11898_recv(struct qcc74x_device_s *dev, struct qcc74x_iso11898_msg_s *msg, uint32_t timeout);
 ...
 * @param [in] mode
 */
void qcc74x_iso11898_set_mode(struct qcc74x_device_s *dev, uint8_t mode);
 ...
 * @return uint8_t
 */
uint8_t qcc74x_iso11898_get_status(struct qcc74x_device_s *dev);
 ...
 * @return uint8_t
 */
uint8_t qcc74x_iso11898_get_mode(struct qcc74x_device_s *dev);
 ...
 * @param [in] filter
 */
void qcc74x_iso11898_set_filter(struct qcc74x_device_s *dev, struct qcc74x_iso11898_filter_s *filter);
 ...
 * @param [in] mask
 */
void qcc74x_iso11898_txint_mask(struct qcc74x_device_s *dev, bool mask);
 ...
 * @param [in] mask
 */
void qcc74x_iso11898_rxint_mask(struct qcc74x_device_s *dev, bool mask);
 ...
 * @param [in] mask
 */
void qcc74x_iso11898_errint_mask(struct qcc74x_device_s *dev, bool mask);
 ...
 * @return uint32_t
 */
uint32_t qcc74x_iso11898_get_int_status(struct qcc74x_device_s *dev);
 ...
 * @return int
 */
int qcc74x_iso11898_feature_control(struct qcc74x_device_s *dev, int cmd, size_t arg);
