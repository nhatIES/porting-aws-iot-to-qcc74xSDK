...
struct qcc74x_dma_channel_lli_pool_s lli[20];
...
void memcpy_test(void)
{
    ...
    printf("ocram2ocram speed:%d MB/s\r\n", K_NUM * 1000000 / 1024 / ((uint32_t)(qcc74x_mtimer_get_time_us() - start_time)));
...
void dma_test()
{
    ...
    dma_chx = qcc74x_device_get_by_name("dma0_ch0");
    ...
    qcc74x_dma_channel_init(dma_chx, &config);
    ...
    start_time = qcc74x_mtimer_get_time_us();
    qcc74x_dma_channel_lli_reload(dma_chx, lli, 20, &transfers, 1);
    qcc74x_dma_channel_start(dma_chx);
    while (qcc74x_dma_channel_isbusy(dma_chx)) {}
    printf("ocram2ocram speed:%d MB/s\r\n", K_NUM * 1000000 / 1024 / ((uint32_t)(qcc74x_mtimer_get_time_us() - start_time)));
