...
qcc74x_flash_otp_config_t flash_otp_cfg;

void ATTR_TCM_SECTION print_param(const qcc74x_flash_secreg_param_t *param)
{
...
bool ATTR_TCM_SECTION print_region(const qcc74x_flash_secreg_region_info_t *info, void *data)
{
    (void)data;
...
bool ATTR_TCM_SECTION region_rwe_test(const qcc74x_flash_secreg_region_info_t *info, void *data)
{
    uint32_t beg;
    uint32_t end;
    ...
    switch (test->test) {
        case REGION_ERASE:
            ...
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_erase_by_idx(&flash_otp_cfg, info->index));
            end = qcc74x_mtimer_get_time_us();
        ...
        case REGION_WRITE:
            ...
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_write_by_idx(&flash_otp_cfg, info->index, 0, test->wbuf + info->secreg_size * info->index, info->secreg_size));
            end = qcc74x_mtimer_get_time_us();
        ...
        case REGION_WREAD:
            ...
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read_by_idx(&flash_otp_cfg, info->index, 0, test->wrbuf + info->secreg_size * info->index, info->secreg_size));
            end = qcc74x_mtimer_get_time_us();
        ...
        case REGION_EREAD:
            ...
            beg = qcc74x_mtimer_get_time_us();
            _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read_by_idx(&flash_otp_cfg, info->index, 0, test->erbuf + info->secreg_size * info->index, info->secreg_size));
            end = qcc74x_mtimer_get_time_us();
...
int ATTR_TCM_SECTION main(void)
{
    ...
    qcc74x_flash_get_cfg(&p_flash_cfg, &flash_cfg_len);
    jedec_id = qcc74x_flash_get_jedec_id();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_get_param(jedec_id, &param));
    ...
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_get_lockbits(&flash_otp_cfg, &lb));
    LOG_I("lock bit is 0x%02x\r\n", lb);
    LOG_I("Test %d ok\r\n", ++count);
    LOG_I("================================\r\n");

    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_region_foreach(&flash_otp_cfg, print_region, NULL));
    LOG_I("Test %d ok\r\n", ++count);
    ...
    test.erase_byte = 0;
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_region_foreach(&flash_otp_cfg, region_rwe_test, (void *)&test));
    ...
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_erase(&flash_otp_cfg, 0, test.erase_byte));
    end = qcc74x_mtimer_get_time_us();
    ...
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read(&flash_otp_cfg, 0, test.erbuf, test.eread_byte));
    end = qcc74x_mtimer_get_time_us();
    ...
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_write(&flash_otp_cfg, 0, test.wbuf, test.write_byte));
    end = qcc74x_mtimer_get_time_us();
    ...
    beg = qcc74x_mtimer_get_time_us();
    _ASSERT_ZERO_FUNC(qcc74x_flash_secreg_read(&flash_otp_cfg, 0, test.wrbuf, test.wread_byte));
    end = qcc74x_mtimer_get_time_us();
