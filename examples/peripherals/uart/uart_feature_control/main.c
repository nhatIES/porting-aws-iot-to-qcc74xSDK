...
int set_baudrate(int argc, char **argv)
{
    ...
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_BAUD_RATE, atoi(argv[1]));
...
int set_databit(int argc, char **argv)
{
    ...
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_DATA_BITS, atoi(argv[1]));
...
int set_stopbit(int argc, char **argv)
{
    ...
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_STOP_BITS, atoi(argv[1]));
...
int set_parity(int argc, char **argv)
{
    ...
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_PARITY_BITS, atoi(argv[1]));
...
int main(void)
{
    ...
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_BAUD_RATE, 2000000);
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_DATA_BITS, UART_DATA_BITS_8);
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_STOP_BITS, UART_STOP_BITS_1);
    qcc74x_uart_feature_control(uartx, UART_CMD_SET_PARITY_BITS, UART_PARITY_EVEN);
    ...
    while (1) {
        ...
        while ((ch = qcc74x_uart_getchar(uartx)) != -1) {
