...
/** @addtogroup  QCC74x_undef_STD_PERIPH_DRIVER
 *  @{
 */
...
static struct qcc74x_i2c_msg_s msgs[2];
...
int ES8388_Write_Reg(uint8_t addr, uint8_t data)
{
    ...
    return qcc74x_i2c_transfer(i2c0, msgs, 2);
}
...
/*@} end of group QCC74x_undef_STD_PERIPH_DRIVER */
