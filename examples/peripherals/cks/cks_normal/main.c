...
static void test_case1(struct qcc74x_device_s *dev) {
    ...
    qcc74x_cks_reset(dev);
    qcc74x_cks_set_endian(dev, CKS_LITTLE_ENDIAN);
    cks = qcc74x_cks_compute(dev, (uint8_t *)data_src1, sizeof(data_src1));
    ...
    qcc74x_cks_reset(dev);
    qcc74x_cks_set_endian(dev, CKS_BIG_ENDIAN);
    cks = qcc74x_cks_compute(dev, (uint8_t *)data_src1, sizeof(data_src1));
...
static void test_case2(struct qcc74x_device_s *dev) {
    ...
    for (i = 0; i < 1; i++) {
        ...
        cks = qcc74x_cks_compute(dev, &data, 1);
...
static void test_case3(struct qcc74x_device_s *dev) {
    uint16_t data_segment_one = 0x3F1F;
    int i;
    uint32_t checksum;
    uint16_t cks;
...
static void test_case4(struct qcc74x_device_s *dev) {
    uint16_t data_segment_one = 0x3F1F;
    ...
    cks = qcc74x_cks_compute(dev, &data_segment_two, 1);
...
static void test_case5(struct qcc74x_device_s *dev) {
    uint16_t sw_cks = 0;
    uint16_t hw_cks = 0;
    uint32_t time = 0;
    ...
    hw_cks = qcc74x_cks_compute(dev, (uint8_t *)data_src1, sizeof(data_src1));
