...
ATTR_NOCACHE_NOINIT_RAM_SECTION struct qcc74x_sha1_link_ctx_s ctx_sha1;
ATTR_NOCACHE_NOINIT_RAM_SECTION struct qcc74x_sha256_link_ctx_s ctx_sha256;
ATTR_NOCACHE_NOINIT_RAM_SECTION struct qcc74x_sha512_link_ctx_s ctx_sha512;
...
int main(void)
{
    ...
    qcc74x_sha1_link_start(sha, &ctx_sha1);
    qcc74x_l1c_dcache_clean_range((void *)sha1_testbuf[0], 104);
    qcc74x_sha1_link_update(sha, &ctx_sha1, sha1_testbuf[0], 104);
    qcc74x_sha1_link_finish(sha, &ctx_sha1, sha_output_buf);
    qcc74x_data_compare(sha1_testsum[0], sha_output_buf, 20);
    printf("sha1 link success\r\n");

    qcc74x_sha256_link_start(sha, &ctx_sha256, 0);
    qcc74x_l1c_dcache_clean_range((void *)sha256_testbuf[0], 104);
    qcc74x_sha256_link_update(sha, &ctx_sha256, sha256_testbuf[0], 104);
    qcc74x_sha256_link_finish(sha, &ctx_sha256, sha_output_buf);
    qcc74x_data_compare(sha256_testsum[0], sha_output_buf, 32);
    printf("sha256 link success\r\n");

#if !defined(QCC74x_undefL)
    qcc74x_sha512_link_start(sha, &ctx_sha512, 0);
    qcc74x_l1c_dcache_clean_range((void *)sha512_testbuf[0], 208);
    qcc74x_sha512_link_update(sha, &ctx_sha512, sha512_testbuf[0], 208);
    qcc74x_sha512_link_finish(sha, &ctx_sha512, sha_output_buf);
    qcc74x_data_compare(sha512_testsum[0], sha_output_buf, 64);
