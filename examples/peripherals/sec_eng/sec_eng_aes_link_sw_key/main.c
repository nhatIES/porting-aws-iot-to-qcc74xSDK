...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_link_s aes_ecb_link = {
...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_link_s aes_cbc_link = {
    .aes_key = AES_LINK_KEY_128BITS, /* 128-bit key mode select */
    .aes_dec_en = 0,                 /* Encode */
    .aes_newkey_dis = 0,             /* Use new key */
    .aes_hwkey_en = 0,               /* Use sw key */
...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_link_s aes_cbc_link2 = {
    .aes_key = AES_LINK_KEY_128BITS, /* 128-bit key mode select */
    .aes_dec_en = 0,                 /* Encode */
    .aes_newkey_dis = 0,             /* Use new key */
    .aes_hwkey_en = 0,               /* Use sw key */
...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_link_s aes_ctr_link = {
    .aes_key = AES_LINK_KEY_128BITS, /* 128-bit key mode select */
    .aes_dec_en = 0,                 /* Encode */
    .aes_newkey_dis = 0,             /* Use new key */
    .aes_hwkey_en = 0,               /* Use sw key */
...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_xts_link_s aes_xts_link1 = {
    .aes_key = AES_LINK_KEY_128BITS, /* 128-bit key mode select */
    .aes_dec_en = 0,                 /* Encode */
    .aes_newkey_dis = 0,             /* Use new key */
    .aes_hwkey_en = 0,               /* Use sw key */
...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_xts_link_s aes_xts_link2 = {
...
ATTR_NOCACHE_RAM_SECTION struct qcc74x_aes_xts_link_s aes_xts_link3 = {
...
static uint32_t qcc74x_data_compare(const uint8_t *expected, uint8_t *input, uint32_t len)
{
    int i = 0;
    for (i = 0; i < len; i++) {
...
int main(void)
{
    ...
    qcc74x_aes_link_update(aes, (uint32_t)&aes_ecb_link, aes_ecb_128bit_pt, aes_enc_buf, 16);
    qcc74x_data_compare(aes_ecb_128bit_ct, aes_enc_buf, 16);
    printf("aes link ecb 128 success\r\n");

    qcc74x_aes_link_update(aes, (uint32_t)&aes_cbc_link, aes_cbc_128bit_pt, aes_enc_buf, 16);
    qcc74x_data_compare(aes_cbc_128bit_ct, aes_enc_buf, 16);
    printf("aes link cbc 128 success\r\n");

    qcc74x_aes_link_update(aes, (uint32_t)&aes_cbc_link2, aes_cbc_128bit_pt, aes_enc_buf, 48);
    qcc74x_data_compare(aes_cbc_128bit_ct, aes_enc_buf, 48);
    printf("aes link cbc 128 success\r\n");

    qcc74x_aes_link_update(aes, (uint32_t)&aes_ctr_link, aes_ctr_128bit_pt, aes_enc_buf, 16);
    qcc74x_data_compare(aes_ctr_128bit_ct, aes_enc_buf, 16);
    printf("aes link ctr 128 success\r\n");

    qcc74x_aes_link_update(aes, (uint32_t)&aes_xts_link1, aes_xts_128bit_pt, aes_enc_buf, 16);
    qcc74x_data_compare(aes_xts_128bit_ct, aes_enc_buf, 16);
    printf("aes link xts 128 success\r\n");

#if !defined(QCC74x_undefL)
    qcc74x_aes_link_update(aes, (uint32_t)&aes_xts_link2, aes_xts_192bit_pt, aes_enc_buf, 32);
    qcc74x_data_compare(aes_xts_192bit_ct, aes_enc_buf, 32);
    printf("aes link xts 192 success\r\n");

    qcc74x_aes_link_update(aes, (uint32_t)&aes_xts_link3, aes_xts_256bit_pt, aes_enc_buf, 32);
    qcc74x_data_compare(aes_xts_256bit_ct, aes_enc_buf, 32);
