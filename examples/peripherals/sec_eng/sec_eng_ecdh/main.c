...
int main(void)
{
    ...
    struct qcc74x_ecdh_s ecdh_handle;
    ...
    for (int type_id = 0; type_id < 2; type_id++) {
        if (type_id == 0) {
            qcc74x_sec_ecdh_init(&ecdh_handle, ECP_SECP256R1);
            printf("ECP_SECP256R1\r\n");
            BUFF_COPY(secp256r1);
        } else if (type_id == 1) {
            qcc74x_sec_ecdh_init(&ecdh_handle, ECP_SECP256K1);
            printf("ECP_SECP256K1\r\n");
            BUFF_COPY(secp256k1);
        }

        printf("Bob calculate encrypt key\r\n");
        time1 = (unsigned int)qcc74x_mtimer_get_time_us();
        qcc74x_sec_ecdh_get_encrypt_key(&ecdh_handle, (uint32_t *)ecdh_public_keyx1, (uint32_t *)ecdh_public_keyy1, (uint32_t *)ecdh_private_key2, ecdh_keyx, ecdh_keyy);
        time2 = (unsigned int)qcc74x_mtimer_get_time_us();
        ...
        time1 = (unsigned int)qcc74x_mtimer_get_time_us();
        qcc74x_sec_ecdh_get_encrypt_key(&ecdh_handle, (uint32_t *)ecdh_public_keyx2, (uint32_t *)ecdh_public_keyy2, (uint32_t *)ecdh_private_key1, ecdh_keyx, ecdh_keyy);
        time2 = (unsigned int)qcc74x_mtimer_get_time_us();
        printf("Get encrypt key time=%dus\r\n", (time2 - time1));
        ...
        time1 = (unsigned int)qcc74x_mtimer_get_time_us();
        qcc74x_sec_ecdh_get_public_key(&ecdh_handle, (uint32_t *)ecdh_private_key, ecdh_keyx, ecdh_keyy);
        time2 = (unsigned int)qcc74x_mtimer_get_time_us();
        ...
        time1 = (unsigned int)qcc74x_mtimer_get_time_us();
        qcc74x_sec_ecdh_get_encrypt_key(&ecdh_handle, ecdh_keyx, ecdh_keyy, (uint32_t *)ecdh_private_key, ecdh_keyx, ecdh_keyy);
        time2 = (unsigned int)qcc74x_mtimer_get_time_us();
