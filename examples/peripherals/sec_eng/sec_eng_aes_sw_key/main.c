...
int main(void)
{
    ...
    qcc74x_aes_setkey(aes, aes_ecb_128bit_key[0], 128);
    qcc74x_aes_encrypt(aes, aes_ecb_128bit_pt[0], aes_ecb_128bit_iv[0], aes_enc_buf, aes_ecb_128bit_len[0]);
    qcc74x_data_compare(aes_ecb_128bit_ct[0], aes_enc_buf, aes_ecb_128bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_ecb_128bit_iv[0], aes_dec_buf, aes_ecb_128bit_len[0]);
    qcc74x_data_compare(aes_ecb_128bit_pt[0], aes_dec_buf, aes_ecb_128bit_len[0]);
    printf("aes ecb 128 success\r\n");

#if !defined(QCC74x_undefL)
    qcc74x_aes_set_mode(aes, AES_MODE_ECB);
    qcc74x_aes_setkey(aes, aes_ecb_192bit_key[0], 192);
    qcc74x_aes_encrypt(aes, aes_ecb_192bit_pt[0], aes_ecb_192bit_iv[0], aes_enc_buf, aes_ecb_192bit_len[0]);
    qcc74x_data_compare(aes_ecb_192bit_ct[0], aes_enc_buf, aes_ecb_192bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_ecb_192bit_iv[0], aes_dec_buf, aes_ecb_192bit_len[0]);
    qcc74x_data_compare(aes_ecb_192bit_pt[0], aes_dec_buf, aes_ecb_192bit_len[0]);
    printf("aes ecb 192 success\r\n");

    qcc74x_aes_set_mode(aes, AES_MODE_ECB);
    qcc74x_aes_setkey(aes, aes_ecb_256bit_key[0], 256);
    qcc74x_aes_encrypt(aes, aes_ecb_256bit_pt[0], aes_ecb_256bit_iv[0], aes_enc_buf, aes_ecb_256bit_len[0]);
    qcc74x_data_compare(aes_ecb_256bit_ct[0], aes_enc_buf, aes_ecb_256bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_ecb_256bit_iv[0], aes_dec_buf, aes_ecb_256bit_len[0]);
    qcc74x_data_compare(aes_ecb_256bit_pt[0], aes_dec_buf, aes_ecb_256bit_len[0]);
    printf("aes ecb 256 success\r\n");
#endif

    qcc74x_aes_set_mode(aes, AES_MODE_CBC);
    qcc74x_aes_setkey(aes, aes_cbc_128bit_key[0], 128);
    qcc74x_aes_encrypt(aes, aes_cbc_128bit_pt[0], aes_cbc_128bit_iv[0], aes_enc_buf, aes_cbc_128bit_len[0]);
    qcc74x_data_compare(aes_cbc_128bit_ct[0], aes_enc_buf, aes_cbc_128bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_cbc_128bit_iv[0], aes_dec_buf, aes_cbc_128bit_len[0]);
    qcc74x_data_compare(aes_cbc_128bit_pt[0], aes_dec_buf, aes_cbc_128bit_len[0]);
    printf("aes cbc 128 success\r\n");

#if !defined(QCC74x_undefL)
    qcc74x_aes_set_mode(aes, AES_MODE_CBC);
    qcc74x_aes_setkey(aes, aes_cbc_192bit_key[0], 192);
    qcc74x_aes_encrypt(aes, aes_cbc_192bit_pt[0], aes_cbc_192bit_iv[0], aes_enc_buf, aes_cbc_192bit_len[0]);
    qcc74x_data_compare(aes_cbc_192bit_ct[0], aes_enc_buf, aes_cbc_192bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_cbc_192bit_iv[0], aes_dec_buf, aes_cbc_192bit_len[0]);
    qcc74x_data_compare(aes_cbc_192bit_pt[0], aes_dec_buf, aes_cbc_192bit_len[0]);
    printf("aes cbc 192 success\r\n");

    qcc74x_aes_set_mode(aes, AES_MODE_CBC);
    qcc74x_aes_setkey(aes, aes_cbc_256bit_key[0], 256);
    qcc74x_aes_encrypt(aes, aes_cbc_256bit_pt[0], aes_cbc_256bit_iv[0], aes_enc_buf, aes_cbc_256bit_len[0]);
    qcc74x_data_compare(aes_cbc_256bit_ct[0], aes_enc_buf, aes_cbc_256bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_cbc_256bit_iv[0], aes_dec_buf, aes_cbc_256bit_len[0]);
    qcc74x_data_compare(aes_cbc_256bit_pt[0], aes_dec_buf, aes_cbc_256bit_len[0]);
    printf("aes cbc 256 success\r\n");
#endif

    qcc74x_aes_set_mode(aes, AES_MODE_CTR);
    qcc74x_aes_setkey(aes, aes_ctr_128bit_key[0], 128);
    qcc74x_aes_encrypt(aes, aes_ctr_128bit_pt[0], aes_ctr_128bit_iv[0], aes_enc_buf, aes_ctr_128bit_len[0]);
    qcc74x_data_compare(aes_ctr_128bit_ct[0], aes_enc_buf, aes_ctr_128bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_ctr_128bit_iv[0], aes_dec_buf, aes_ctr_128bit_len[0]);
    qcc74x_data_compare(aes_ctr_128bit_pt[0], aes_dec_buf, aes_ctr_128bit_len[0]);
    printf("aes ctr 128 success\r\n");

#if !defined(QCC74x_undefL)
    qcc74x_aes_set_mode(aes, AES_MODE_CTR);
    qcc74x_aes_setkey(aes, aes_ctr_192bit_key[0], 192);
    qcc74x_aes_encrypt(aes, aes_ctr_192bit_pt[0], aes_ctr_192bit_iv[0], aes_enc_buf, aes_ctr_192bit_len[0]);
    qcc74x_data_compare(aes_ctr_192bit_ct[0], aes_enc_buf, aes_ctr_192bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_ctr_192bit_iv[0], aes_dec_buf, aes_ctr_192bit_len[0]);
    qcc74x_data_compare(aes_ctr_192bit_pt[0], aes_dec_buf, aes_ctr_192bit_len[0]);
    printf("aes ctr 192 success\r\n");

    qcc74x_aes_set_mode(aes, AES_MODE_CTR);
    qcc74x_aes_setkey(aes, aes_ctr_256bit_key[0], 256);
    qcc74x_aes_encrypt(aes, aes_ctr_256bit_pt[0], aes_ctr_256bit_iv[0], aes_enc_buf, aes_ctr_256bit_len[0]);
    qcc74x_data_compare(aes_ctr_256bit_ct[0], aes_enc_buf, aes_ctr_256bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_ctr_256bit_iv[0], aes_dec_buf, aes_ctr_256bit_len[0]);
    qcc74x_data_compare(aes_ctr_256bit_pt[0], aes_dec_buf, aes_ctr_256bit_len[0]);
    printf("aes ctr 256 success\r\n");
#endif

    qcc74x_aes_set_mode(aes, AES_MODE_XTS);
    qcc74x_aes_setkey(aes, aes_xts_128bit_key[0], 128);
    qcc74x_aes_encrypt(aes, aes_xts_128bit_pt[0], aes_xts_128bit_iv[0], aes_enc_buf, aes_xts_128bit_len[0]);
    qcc74x_data_compare(aes_xts_128bit_ct[0], aes_enc_buf, aes_xts_128bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_xts_128bit_iv[0], aes_dec_buf, aes_xts_128bit_len[0]);
    qcc74x_data_compare(aes_xts_128bit_pt[0], aes_dec_buf, aes_xts_128bit_len[0]);
    printf("aes xts 128 success\r\n");

#if !defined(QCC74x_undefL)
    qcc74x_aes_set_mode(aes, AES_MODE_XTS);
    qcc74x_aes_setkey(aes, aes_xts_192bit_key[0], 192);
    qcc74x_aes_encrypt(aes, aes_xts_192bit_pt[0], aes_xts_192bit_iv[0], aes_enc_buf, aes_xts_192bit_len[0]);
    qcc74x_data_compare(aes_xts_192bit_ct[0], aes_enc_buf, aes_xts_192bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_xts_192bit_iv[0], aes_dec_buf, aes_xts_192bit_len[0]);
    qcc74x_data_compare(aes_xts_192bit_pt[0], aes_dec_buf, aes_xts_192bit_len[0]);
    printf("aes xts 192 success\r\n");

    qcc74x_aes_set_mode(aes, AES_MODE_XTS);
    qcc74x_aes_setkey(aes, aes_xts_256bit_key[0], 256);
    qcc74x_aes_encrypt(aes, aes_xts_256bit_pt[0], aes_xts_256bit_iv[0], aes_enc_buf, aes_xts_256bit_len[0]);
    qcc74x_data_compare(aes_xts_256bit_ct[0], aes_enc_buf, aes_xts_256bit_len[0]);
    qcc74x_aes_decrypt(aes, aes_enc_buf, aes_xts_256bit_iv[0], aes_dec_buf, aes_xts_256bit_len[0]);
    qcc74x_data_compare(aes_xts_256bit_pt[0], aes_dec_buf, aes_xts_256bit_len[0]);
