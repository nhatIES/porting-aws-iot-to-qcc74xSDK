...
int main(void)
{
    ...
    uint32_t i = 0;
    uint8_t *k;
    struct qcc74x_dsa_s dsa_handle;
    uint32_t time = 0;

    printf("DSA Case\r\n");

    qcc74x_sec_dsa_init(&dsa_handle, 1024);
    ...
    if (0 != qcc74x_sec_dsa_sign(&dsa_handle, (uint32_t *)c, 8, dsa_tmp)) {
        printf("Sign Fail\r\n");
    }
    ...
    if (0 != qcc74x_sec_dsa_verify(&dsa_handle, (uint32_t *)c, 8, (uint32_t *)m)) {
