...
int main(void)
{
    ...
    qcc74x_spi_link_rxdma(spi0, true);
    ...
    qcc74x_dma_channel_lli_reload(dma0_ch0, tx_llipool, 1, tx_transfers, 1);
    qcc74x_dma_channel_lli_reload(dma0_ch1, rx_llipool, 1, rx_transfers, 1);
