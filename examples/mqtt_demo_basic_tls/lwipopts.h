...
#if defined(CFG_CHIP_QCC74x_undef)||defined(CFG_ETHERNET_ENABLE)
...
#if defined(CFG_CHIP_QCC74x_undefP)
#define LWIP_DECLARE_MEMORY_ALIGNED(variable_name, size) u8_t variable_name[LWIP_MEM_ALIGN_BUFFER(size)]
#endif
...
extern "C" int qcc74x_rand(void);
extern "C" int * __errno(void);
#else
extern int qcc74x_rand(void);
...
#define LWIP_RAND() ((u32_t)qcc74x_rand())
