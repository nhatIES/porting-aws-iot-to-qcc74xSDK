...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "qcc74x_mtimer.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR ((uint32_t)qcc74x_mtimer_get_time_ms())    /*Expression evaluating to current system time in ms*/
