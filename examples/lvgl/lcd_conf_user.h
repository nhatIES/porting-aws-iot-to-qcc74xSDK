...
/* dbi ili9488 config */
    ...
    /* Selecting interface type, more configuration of peripherals comes later
        1: DBI peripheral, supported functions: typeC-3wire, typeC-4wire, typeB-x8(8080); (support chips: qcc743, qcc74x_undefp, qcc74x_undef),
    */
...
/* dbi ili9341 config */
   ...
   /* dbi ili9341 config */
    ...
    /* Selecting interface type, more configuration of peripherals comes later
        1: DBI peripheral, supported functions: typeB-x8(8080); (support chips: qcc743, qcc74x_undefp, qcc74x_undef),
    */
    #define LCD_DBI_INTERFACE_TYPE 1
...
/* dpi ili9488 config */
    ...
    */
    ...
    /* Selecting initialization interface
        ...
        2: Hardware dbi peripheral typeC (support: qcc743, qcc74x_undefp, qcc74x_undef)
    */
