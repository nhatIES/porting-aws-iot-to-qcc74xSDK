...
#include <stdint.h>
#include <msp_dma.h>
#include <msp_qcc74x_undefp_dma.h>
#include <msp_qcc74x_undefp_glb.h>
...
extern QCC74x_Err_Type GLB_Set_DMA_CLK(uint8_t enable, GLB_DMA_CLK_ID_Type clk);
extern QCC74x_Err_Type GLB_PER_Clock_UnGate(uint64_t ips);
