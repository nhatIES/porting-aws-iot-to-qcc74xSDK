#ifndef __MSP_QCC743_AUADC_H__
#define __MSP_QCC743_AUADC_H__

#include "msp_qcc743_platform.h"
#include "msp_qcc743_auadc_reg.h"
...
typedef struct {
    ...
    QCC74x_Fun_Type dmaEn;                              /*!< enable DMA FIFO interface */
} AUADC_FifoCfg_Type;
...
typedef struct {
    ...
    QCC74x_Fun_Type adc_clock_phase_invert_en;             /* adc clock phase invert */
    ...
    QCC74x_Fun_Type pga_chopper_en;                        /* PGA chopper control, ENABLE or DISABLE */
    ...
    QCC74x_Fun_Type sdm_lowpower_en;                         /* SDM lowpower funciton en, ENABLE: 0.6 of disable */
    ...
    QCC74x_Fun_Type dem_en;                                  /* dem function control, ENABLE or DISABLE */
    AUADC_ADC_SDM_QuantizerGain_Type sdm_qg;             /* quantizer gain control for SDM */
    QCC74x_Fun_Type sdm_dither_en;                           /* dither control, ENABLE or DISABLE */
    ...
    QCC74x_Fun_Type pga_circuit_en;                            /* PGA related circuit enable */
    QCC74x_Fun_Type sdm_circuit_en;                            /* SDM related circuit enable */
    QCC74x_Fun_Type pga_positive_en;                           /* DISABLE, look into each channel will see high impedance, ENABLE:one of eight channel will be choose */
    QCC74x_Fun_Type pga_negative_en;                           /* DISABLE, look into each channel will see high impedance, ENABLE:one of eight channel will be choose */
