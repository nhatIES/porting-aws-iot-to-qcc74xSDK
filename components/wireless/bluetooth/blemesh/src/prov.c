...
#if defined(QCC74x_BLE_MESH_PATCH_PROV_NODE_CFM_RECVED_BEFORE_DH)
	WAIT_DH_KEY,           /* Waiting for DHKey to be generated */
#endif /* QCC74x_BLE_MESH_PATCH_PROV_NODE_CFM_RECVED_BEFORE_DH */
...
static void prov_start(const u8_t *data)
{
	...
	/** Modified by qcc74x. TODO(may to needn't this modify)
	 * 
	 * prov callback function. And get provisioner's provisioning start
	 * parameter.
	 */
