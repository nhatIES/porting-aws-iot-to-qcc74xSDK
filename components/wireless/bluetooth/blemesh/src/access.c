...
#include <zephyr.h>
#include <bt_errno.h>
#include <util.h> /* Modified by qcc74x */
#include <byteorder.h> /* Modified by qcc74x */

#include <net/buf.h>
#include <bluetooth.h> /* Modified by qcc74x */
#include <include/mesh.h> /* Modified by qcc74x */

#define BT_DBG_ENABLED IS_ENABLED(CONFIG_BT_MESH_DEBUG_ACCESS)
#define LOG_MODULE_NAME bt_mesh_access
#include "bt_log.h" /* Modified by qcc74x */
