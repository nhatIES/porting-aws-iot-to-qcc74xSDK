...
#if defined(QCC74x_MCU_SDK)
#define BT_DBG(fmt, ...)   //qcc74x_platform_printf(fmt", %s\r\n", ##__VA_ARGS__, __func__)
#define BT_ERR(fmt, ...)   qcc74x_platform_printf(fmt", %s\r\n", ##__VA_ARGS__, __func__)
#define BT_WARN(fmt, ...)  qcc74x_platform_printf(fmt", %s\r\n", ##__VA_ARGS__, __func__)
#define BT_INFO(fmt, ...)   //qcc74x_platform_printf(fmt", %s\r\n", ##__VA_ARGS__, __func__)
#else
...
#if defined(QCC74x_MCU_SDK)
#define BT_PTS(fmt, ...)   qcc74x_platform_printf("[PTS]"fmt"\r\n", ##__VA_ARGS__)
#else
