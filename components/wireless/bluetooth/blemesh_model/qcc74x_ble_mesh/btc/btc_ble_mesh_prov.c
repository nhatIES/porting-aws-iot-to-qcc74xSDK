...
//#include "qcc74x_ble_mesh_common_api.h"
#include "qcc74x_ble_mesh_provisioning_api.h"
#include "qcc74x_ble_mesh_networking_api.h"

static inline void btc_ble_mesh_prov_cb_to_app(qcc74x_ble_mesh_prov_cb_event_t event,
        qcc74x_ble_mesh_prov_cb_param_t *param)
{
    qcc74x_ble_mesh_prov_cb_t btc_ble_mesh_cb =
        (qcc74x_ble_mesh_prov_cb_t)btc_profile_cb_get(BTC_PID_PROV);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}

static inline void btc_ble_mesh_model_cb_to_app(qcc74x_ble_mesh_model_cb_event_t event,
        qcc74x_ble_mesh_model_cb_param_t *param)
{
    qcc74x_ble_mesh_model_cb_t btc_ble_mesh_cb =
        (qcc74x_ble_mesh_model_cb_t)btc_profile_cb_get(BTC_PID_MODEL);
    if (btc_ble_mesh_cb) {
        btc_ble_mesh_cb(event, param);
    }
}
...
void btc_ble_mesh_model_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_BLE_MESH_ACT_CLIENT_MODEL_SEND: {
        ...
        dst->model_send.ctx = bt_mesh_malloc(sizeof(qcc74x_ble_mesh_msg_ctx_t));
        ...
        if (dst->model_send.ctx) {
            memcpy(dst->model_send.ctx, src->model_send.ctx, sizeof(qcc74x_ble_mesh_msg_ctx_t));
        } else {
            BT_ERR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
    ...
    case BTC_BLE_MESH_ACT_SERVER_MODEL_UPDATE_STATE:
        ...
        dst->model_update_state.value = bt_mesh_malloc(sizeof(qcc74x_ble_mesh_server_state_value_t));
        if (dst->model_update_state.value) {
            memcpy(dst->model_update_state.value, src->model_update_state.value,
                   sizeof(qcc74x_ble_mesh_server_state_value_t));
        } else {
            BT_ERR("%s, Failed to allocate memory, act %d", __func__, msg->act);
        }
        break;
...
{
    qcc74x_ble_mesh_model_cb_param_t *p_dest_data = (qcc74x_ble_mesh_model_cb_param_t *)p_dest;
    qcc74x_ble_mesh_model_cb_param_t *p_src_data = (qcc74x_ble_mesh_model_cb_param_t *)p_src;
    ...
    switch (msg->act) {
    case QCC74x_BLE_MESH_MODEL_OPERATION_EVT: {
        if (p_src_data->model_operation.ctx && p_src_data->model_operation.msg) {
            p_dest_data->model_operation.ctx = bt_mesh_malloc(sizeof(qcc74x_ble_mesh_msg_ctx_t));
            ...
            if (p_dest_data->model_operation.ctx) {
                memcpy(p_dest_data->model_operation.ctx, p_src_data->model_operation.ctx, sizeof(qcc74x_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
    ...
    case QCC74x_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT: {
        if (p_src_data->client_recv_publish_msg.ctx && p_src_data->client_recv_publish_msg.msg) {
            p_dest_data->client_recv_publish_msg.ctx = bt_mesh_malloc(sizeof(qcc74x_ble_mesh_msg_ctx_t));
            ...
            if (p_dest_data->client_recv_publish_msg.ctx) {
                memcpy(p_dest_data->client_recv_publish_msg.ctx, p_src_data->client_recv_publish_msg.ctx, sizeof(qcc74x_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
    ...
    case QCC74x_BLE_MESH_MODEL_SEND_COMP_EVT: {
        if (p_src_data->model_send_comp.ctx) {
            p_dest_data->model_send_comp.ctx = bt_mesh_malloc(sizeof(qcc74x_ble_mesh_msg_ctx_t));
            if (p_dest_data->model_send_comp.ctx) {
                memcpy(p_dest_data->model_send_comp.ctx, p_src_data->model_send_comp.ctx, sizeof(qcc74x_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
        }
    ...
    case QCC74x_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT: {
        if (p_src_data->client_send_timeout.ctx) {
            p_dest_data->client_send_timeout.ctx = bt_mesh_malloc(sizeof(qcc74x_ble_mesh_msg_ctx_t));
            if (p_dest_data->client_send_timeout.ctx) {
                memcpy(p_dest_data->client_send_timeout.ctx, p_src_data->client_send_timeout.ctx, sizeof(qcc74x_ble_mesh_msg_ctx_t));
            } else {
                BT_ERR("%s, Failed to allocate memory, act %d", __func__, msg->act);
            }
        }
...
{
    qcc74x_ble_mesh_model_cb_param_t *arg = NULL;
    ...
    arg = (qcc74x_ble_mesh_model_cb_param_t *)(msg->arg);
...
#endif
static bt_status_t btc_ble_mesh_model_callback(qcc74x_ble_mesh_model_cb_param_t *param, uint8_t act)
{
    btc_msg_t msg = {0};
    ...
    ret = btc_transfer_context(&msg, param,
                               sizeof(qcc74x_ble_mesh_model_cb_param_t), NULL);
...
{
    qcc74x_ble_mesh_model_cb_param_t mesh_param = {0};

    mesh_param.model_operation.opcode = ctx->recv_op;
    mesh_param.model_operation.model = (qcc74x_ble_mesh_model_t *)model;
    mesh_param.model_operation.ctx = (qcc74x_ble_mesh_msg_ctx_t *)ctx;
    mesh_param.model_operation.length = buf->len;
    mesh_param.model_operation.msg = buf->data;

    btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_MODEL_OPERATION_EVT);
    return;
}
        ...
        struct net_buf_simple *buf)
{
    ...
    if (node == NULL) {
        ...
        mesh_param.client_recv_publish_msg.model = (qcc74x_ble_mesh_model_t *)model;
        mesh_param.client_recv_publish_msg.ctx = (qcc74x_ble_mesh_msg_ctx_t *)ctx;
        mesh_param.client_recv_publish_msg.length = buf->len;
        mesh_param.client_recv_publish_msg.msg = buf->data;
        btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_CLIENT_MODEL_RECV_PUBLISH_MSG_EVT);
    } else {
        mesh_param.model_operation.opcode = ctx->recv_op;
        mesh_param.model_operation.model = (qcc74x_ble_mesh_model_t *)model;
        mesh_param.model_operation.ctx = (qcc74x_ble_mesh_msg_ctx_t *)ctx;
...
static void btc_ble_mesh_client_model_timeout_cb(struct k_work *work)
{
    ...
    if (timer && !k_delayed_work_free(timer)) {
        ...
        if (node) {
            ...
            mesh_param.client_send_timeout.model = (qcc74x_ble_mesh_model_t *)ctx.model;
            mesh_param.client_send_timeout.ctx = (qcc74x_ble_mesh_msg_ctx_t *)&ctx;
            bt_mesh_client_free_node(node);
            btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_CLIENT_MODEL_SEND_TIMEOUT_EVT);
        }
    }
...
static void btc_ble_mesh_model_send_comp_cb(qcc74x_ble_mesh_model_t *model, qcc74x_ble_mesh_msg_ctx_t *ctx, u32_t opcode, int err)
{
    qcc74x_ble_mesh_model_cb_param_t mesh_param = {0};
    ...
    btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_MODEL_SEND_COMP_EVT);
    return;
}

static void btc_ble_mesh_model_publish_comp_cb(qcc74x_ble_mesh_model_t *model, int err)
{
    qcc74x_ble_mesh_model_cb_param_t mesh_param = {0};
    ...
    btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_MODEL_PUBLISH_COMP_EVT);
    return;
}
...
int btc_ble_mesh_model_publish_update(struct bt_mesh_model *mod)
{
    ...
    mesh_param.model_publish_update.model = (qcc74x_ble_mesh_model_t *)mod;

    ret = btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_MODEL_PUBLISH_UPDATE_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}

static void btc_ble_mesh_server_model_update_state_comp_cb(qcc74x_ble_mesh_model_t *model,
        qcc74x_ble_mesh_server_state_type_t type, int err)
{
    qcc74x_ble_mesh_model_cb_param_t mesh_param = {0};
    ...
    btc_ble_mesh_model_callback(&mesh_param, QCC74x_BLE_MESH_SERVER_MODEL_UPDATE_STATE_COMP_EVT);
    return;
}

static bt_status_t btc_ble_mesh_prov_callback(qcc74x_ble_mesh_prov_cb_param_t *param, uint8_t act)
{
    btc_msg_t msg = {0};
    bt_status_t ret = BT_STATUS_SUCCESS;
    ...
    ret = btc_transfer_context(&msg, param, sizeof(qcc74x_ble_mesh_prov_cb_param_t), NULL);
    if (ret != BT_STATUS_SUCCESS) {
        BT_ERR("%s, btc_transfer_context failed", __func__);
    }
    return ret;
...
static void btc_ble_mesh_oob_pub_key_cb(void)
{
    ...
    btc_ble_mesh_prov_callback(NULL, QCC74x_BLE_MESH_NODE_PROV_OOB_PUB_KEY_EVT);
    return;
}

static int btc_ble_mesh_output_number_cb(bt_mesh_output_action_t act, u32_t num)
{
    qcc74x_ble_mesh_prov_cb_param_t mesh_param = {0};
    bt_status_t ret = BT_STATUS_SUCCESS;

    BT_DBG("%s", __func__);

    mesh_param.node_prov_output_num.action = (qcc74x_ble_mesh_output_action_t)act;
    mesh_param.node_prov_output_num.number = num;

    ret = btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_NODE_PROV_OUTPUT_NUMBER_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static int btc_ble_mesh_output_string_cb(const char *str)
{
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_NODE_PROV_OUTPUT_STRING_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static int btc_ble_mesh_input_cb(bt_mesh_input_action_t act, u8_t size)
{
    ...
    mesh_param.node_prov_input.action = (qcc74x_ble_mesh_input_action_t)act;
    mesh_param.node_prov_input.size = size;

    ret = btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_NODE_PROV_INPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static void btc_ble_mesh_link_open_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    mesh_param.node_prov_link_open.bearer = (qcc74x_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_NODE_PROV_LINK_OPEN_EVT);
    return;
}
...
static void btc_ble_mesh_link_close_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    mesh_param.node_prov_link_close.bearer = (qcc74x_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_NODE_PROV_LINK_CLOSE_EVT);
    return;
}
...
static void btc_ble_mesh_complete_cb(u16_t net_idx, const u8_t net_key[16], u16_t addr, u8_t flags, u32_t iv_index)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_NODE_PROV_COMPLETE_EVT);
    return;
}
...
static void btc_ble_mesh_reset_cb(void)
{
    ...
    btc_ble_mesh_prov_callback(NULL, QCC74x_BLE_MESH_NODE_PROV_RESET_EVT);
    return;
}
...
static void btc_ble_mesh_prov_register_complete_cb(int err_code)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROV_REGISTER_COMP_EVT);
    return;
}

static void btc_ble_mesh_prov_set_complete_cb(qcc74x_ble_mesh_prov_cb_param_t *param, uint8_t act)
{
    BT_DBG("%s", __func__);
    ...
    u16_t oob_info, bt_mesh_prov_bearer_t bearer, s8_t rssi)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_RECV_UNPROV_ADV_PKT_EVT);
    return;
}
...
static int btc_ble_mesh_provisioner_prov_read_oob_pub_key_cb(u8_t link_idx)
{
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_PROV_READ_OOB_PUB_KEY_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
        ...
        bt_mesh_output_action_t act, u8_t size, u8_t link_idx)
{
    ...
    mesh_param.provisioner_prov_input.method = (qcc74x_ble_mesh_oob_method_t)method;
    mesh_param.provisioner_prov_input.action = (qcc74x_ble_mesh_output_action_t)act;
    mesh_param.provisioner_prov_input.size = size;
    mesh_param.provisioner_prov_input.link_idx = link_idx;

    ret = btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_PROV_INPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
        ...
        bt_mesh_input_action_t act, void *data, u8_t size, u8_t link_idx)
{
    ...
    mesh_param.provisioner_prov_output.method = (qcc74x_ble_mesh_oob_method_t)method;
    mesh_param.provisioner_prov_output.action = (qcc74x_ble_mesh_input_action_t)act;
    ...
    ret = btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_PROV_OUTPUT_EVT);
    return (ret == BT_STATUS_SUCCESS) ? 0 : -1;
}
...
static void btc_ble_mesh_provisioner_link_open_cb(bt_mesh_prov_bearer_t bearer)
{
    ...
    mesh_param.provisioner_prov_link_open.bearer = (qcc74x_ble_mesh_prov_bearer_t)bearer;

    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_PROV_LINK_OPEN_EVT);
    return;
}
...
static void btc_ble_mesh_provisioner_link_close_cb(bt_mesh_prov_bearer_t bearer, u8_t reason)
{
    ...
    mesh_param.provisioner_prov_link_close.bearer = (qcc74x_ble_mesh_prov_bearer_t)bearer;
    mesh_param.provisioner_prov_link_close.reason = reason;

    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_PROV_LINK_CLOSE_EVT);
    return;
}
    ...
    u16_t netkey_idx)
{
    ...
    memcpy(mesh_param.provisioner_prov_complete.device_uuid, device_uuid, sizeof(qcc74x_ble_mesh_octet16_t));

    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROVISIONER_PROV_COMPLETE_EVT);
    return;
}

qcc74x_ble_mesh_node_t *btc_ble_mesh_provisioner_get_node_with_uuid(const uint8_t uuid[16])
{
    return (qcc74x_ble_mesh_node_t *)bt_mesh_provisioner_get_node_with_uuid(uuid);
}

qcc74x_ble_mesh_node_t *btc_ble_mesh_provisioner_get_node_with_addr(uint16_t unicast_addr)
{
    return (qcc74x_ble_mesh_node_t *)bt_mesh_provisioner_get_node_with_addr(unicast_addr);
}
...
static void btc_ble_mesh_heartbeat_msg_recv_cb(u8_t hops, u16_t feature)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_HEARTBEAT_MESSAGE_RECV_EVT);
    return;
}
#endif
...
static void btc_ble_mesh_lpn_cb(u16_t friend_addr, bool established)
{
    ...
    if (established) {
        ...
        act = QCC74x_BLE_MESH_LPN_FRIENDSHIP_ESTABLISH_EVT;
    } else {
        mesh_param.lpn_friendship_terminate.friend_addr = friend_addr;
        act = QCC74x_BLE_MESH_LPN_FRIENDSHIP_TERMINATE_EVT;
    }
        ...
        u8_t type, bt_mesh_proxy_adv_ctx_t *ctx, s8_t rssi)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROXY_CLIENT_RECV_ADV_PKT_EVT);
    return;
}
        ...
        u8_t conn_handle, u16_t net_idx)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROXY_CLIENT_CONNECTED_EVT);
    return;
}
        ...
        u8_t conn_handle, u16_t net_idx, u8_t reason)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROXY_CLIENT_DISCONNECTED_EVT);
    return;
}
        ...
        u16_t src, u16_t net_idx, u8_t filter_type, u16_t list_size)
{
    ...
    btc_ble_mesh_prov_callback(&mesh_param, QCC74x_BLE_MESH_PROXY_CLIENT_RECV_FILTER_STATUS_EVT);
    return;
}
...
int btc_ble_mesh_client_model_init(qcc74x_ble_mesh_model_t *model)
{
    ...
    qcc74x_ble_mesh_model_op_t *op = (qcc74x_ble_mesh_model_op_t *)model->op;
...
{
    return (qcc74x_ble_mesh_elem_t *)bt_mesh_elem_find(addr);
}
...
{
    return (qcc74x_ble_mesh_model_t *)bt_mesh_model_find_vnd((struct bt_mesh_elem *)elem, company, id);
}

qcc74x_ble_mesh_model_t *btc_ble_mesh_model_find(const qcc74x_ble_mesh_elem_t *elem, uint16_t id)
{
    return (qcc74x_ble_mesh_model_t *)bt_mesh_model_find((struct bt_mesh_elem *)elem, id);
}

const qcc74x_ble_mesh_comp_t *btc_ble_mesh_comp_get(void)
{
    return (const qcc74x_ble_mesh_comp_t *)bt_mesh_comp_get();
}
...
static void btc_ble_mesh_model_op_add(qcc74x_ble_mesh_model_t *model)
{
    qcc74x_ble_mesh_model_op_t *op = NULL;
    ...
    case BT_MESH_MODEL_ID_CFG_SRV: {
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)bt_mesh_cfg_srv_op;
    ...
    case BT_MESH_MODEL_ID_CFG_CLI: {
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)bt_mesh_cfg_cli_op;
    ...
    case BT_MESH_MODEL_ID_HEALTH_SRV: {
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)bt_mesh_health_srv_op;
    ...
    case BT_MESH_MODEL_ID_HEALTH_CLI: {
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)bt_mesh_health_cli_op;
    ...
    case BT_MESH_MODEL_ID_SENSOR_CLI: {
		#if 0
        model->op = ((qcc74x_ble_mesh_model_op_t *)sensor_cli_op);
    ...
    case BT_MESH_MODEL_ID_TIME_CLI: {
		#if 0
        model->op = ((qcc74x_ble_mesh_model_op_t *)time_cli_op);
    ...
    case BT_MESH_MODEL_ID_SCENE_CLI: {
		#if 0
        model->op = ((qcc74x_ble_mesh_model_op_t *)scene_cli_op);
    ...
    case BT_MESH_MODEL_ID_SCHEDULER_CLI: {
		#if 0
        model->op = ((qcc74x_ble_mesh_model_op_t *)scheduler_cli_op);
    ...
    case BT_MESH_MODEL_ID_TIME_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)time_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
        break;
    case BT_MESH_MODEL_ID_TIME_SETUP_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)time_setup_srv_op;
        if (model->pub) {
    ...
    case BT_MESH_MODEL_ID_SCENE_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)scene_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
    ...
    case BT_MESH_MODEL_ID_SCENE_SETUP_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)scene_setup_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
    ...
    case BT_MESH_MODEL_ID_SCHEDULER_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)scheduler_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
    ...
    case BT_MESH_MODEL_ID_SCHEDULER_SETUP_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)scheduler_setup_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
    ...
    case BT_MESH_MODEL_ID_SENSOR_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)sensor_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
    ...
    case BT_MESH_MODEL_ID_SENSOR_SETUP_SRV:
		#if 0
        model->op = (qcc74x_ble_mesh_model_op_t *)sensor_setup_srv_op;
        if (model->pub) {
            model->pub->update = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_model_publish_update;
        }
		#endif
...
add_model_op:
    ...
    op = (qcc74x_ble_mesh_model_op_t *)model->op;
    while (op != NULL && op->opcode != 0) {
...
{
    qcc74x_ble_mesh_prov_cb_param_t param = {0};
    btc_ble_mesh_prov_args_t *arg = NULL;
    uint8_t act = 0U;
    ...
    case BTC_BLE_MESH_ACT_MESH_INIT: {
        ...
        for (int i = 0; i < arg->mesh_init.comp->elem_count; i++) {
            qcc74x_ble_mesh_elem_t *elem = &arg->mesh_init.comp->elem[i];
            /* For SIG models */
            for (int j = 0; j < elem->model_count; j++) {
                qcc74x_ble_mesh_model_t *sig_model = &elem->models[j];
            ...
            for (int k = 0; k < elem->vnd_model_count; k++) {
                qcc74x_ble_mesh_model_t *vnd_model = &elem->vnd_models[k];
...
#if CONFIG_BLE_MESH_NODE
        arg->mesh_init.prov->oob_pub_key_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_oob_pub_key_cb;
        arg->mesh_init.prov->output_num_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_output_number_cb;
        arg->mesh_init.prov->output_str_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_output_string_cb;
        arg->mesh_init.prov->input_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_input_cb;
        arg->mesh_init.prov->link_open_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_link_open_cb;
        arg->mesh_init.prov->link_close_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_link_close_cb;
        arg->mesh_init.prov->complete_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_complete_cb;
        arg->mesh_init.prov->reset_cb = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_reset_cb;
#endif /* CONFIG_BLE_MESH_NODE */
#if CONFIG_BLE_MESH_PROVISIONER
        arg->mesh_init.prov->provisioner_prov_read_oob_pub_key = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_read_oob_pub_key_cb;
        arg->mesh_init.prov->provisioner_prov_input = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_input_cb;
        arg->mesh_init.prov->provisioner_prov_output = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_output_cb;
        arg->mesh_init.prov->provisioner_link_open = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_provisioner_link_open_cb;
        arg->mesh_init.prov->provisioner_link_close = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_provisioner_link_close_cb;
        arg->mesh_init.prov->provisioner_prov_comp = (qcc74x_ble_mesh_cb_t)btc_ble_mesh_provisioner_prov_complete_cb;
    ...
    case BTC_BLE_MESH_ACT_PROV_ENABLE:
        ...
        act = QCC74x_BLE_MESH_NODE_PROV_ENABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROV_DISABLE:
        ...
        act = QCC74x_BLE_MESH_NODE_PROV_DISABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_OOB_PUB_KEY:
		#if 0
        act = QCC74x_BLE_MESH_NODE_PROV_SET_OOB_PUB_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_DEVICE_NAME:
        act = QCC74x_BLE_MESH_NODE_SET_UNPROV_DEV_NAME_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_READ_OOB_PUB_KEY:
        act = QCC74x_BLE_MESH_PROVISIONER_PROV_READ_OOB_PUB_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_INPUT_STR:
        act = QCC74x_BLE_MESH_PROVISIONER_PROV_INPUT_STRING_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_INPUT_NUM:
        act = QCC74x_BLE_MESH_PROVISIONER_PROV_INPUT_NUMBER_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ENABLE:
        act = QCC74x_BLE_MESH_PROVISIONER_PROV_ENABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DISABLE:
        act = QCC74x_BLE_MESH_PROVISIONER_PROV_DISABLE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DEV_ADD: {
        ...
        act = QCC74x_BLE_MESH_PROVISIONER_ADD_UNPROV_DEV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_PROV_DEV_WITH_ADDR:
        act = QCC74x_BLE_MESH_PROVISIONER_PROV_DEV_WITH_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DEV_DEL: {
        ...
        act = QCC74x_BLE_MESH_PROVISIONER_DELETE_DEV_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_DEV_UUID_MATCH:
        act = QCC74x_BLE_MESH_PROVISIONER_SET_DEV_UUID_MATCH_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_PROV_DATA_INFO: {
        ...
        act = QCC74x_BLE_MESH_PROVISIONER_SET_PROV_DATA_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_STATIC_OOB_VAL:
        act = QCC74x_BLE_MESH_PROVISIONER_SET_STATIC_OOB_VALUE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_PRIMARY_ELEM_ADDR:
        act = QCC74x_BLE_MESH_PROVISIONER_SET_PRIMARY_ELEM_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_SET_NODE_NAME:
        act = QCC74x_BLE_MESH_PROVISIONER_SET_NODE_NAME_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ADD_LOCAL_APP_KEY: {
        ...
        act = QCC74x_BLE_MESH_PROVISIONER_ADD_LOCAL_APP_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_UPDATE_LOCAL_APP_KEY:
        act = QCC74x_BLE_MESH_PROVISIONER_UPDATE_LOCAL_APP_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_BIND_LOCAL_MOD_APP:
        act = QCC74x_BLE_MESH_PROVISIONER_BIND_APP_KEY_TO_MODEL_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_ADD_LOCAL_NET_KEY: {
        ...
        act = QCC74x_BLE_MESH_PROVISIONER_ADD_LOCAL_NET_KEY_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_UPDATE_LOCAL_NET_KEY:
        act = QCC74x_BLE_MESH_PROVISIONER_UPDATE_LOCAL_NET_KEY_COMP_EVT;
        ...
        break;
    case BTC_BLE_MESH_ACT_PROVISIONER_STORE_NODE_COMP_DATA:
        act = QCC74x_BLE_MESH_PROVISIONER_STORE_NODE_COMP_DATA_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DELETE_NODE_WITH_UUID:
        act = QCC74x_BLE_MESH_PROVISIONER_DELETE_NODE_WITH_UUID_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROVISIONER_DELETE_NODE_WITH_ADDR:
        act = QCC74x_BLE_MESH_PROVISIONER_DELETE_NODE_WITH_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_FAST_PROV_INFO:
        act = QCC74x_BLE_MESH_SET_FAST_PROV_INFO_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_SET_FAST_PROV_ACTION:
        act = QCC74x_BLE_MESH_SET_FAST_PROV_ACTION_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_DISCONNECT:
        act = QCC74x_BLE_MESH_PROXY_CLIENT_DISCONNECT_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_SET_FILTER_TYPE: {
        ...
        act = QCC74x_BLE_MESH_PROXY_CLIENT_SET_FILTER_TYPE_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_ADD_FILTER_ADDR: {
        ...
        act = QCC74x_BLE_MESH_PROXY_CLIENT_ADD_FILTER_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_PROXY_CLIENT_REMOVE_FILTER_ADDR: {
        ...
        act = QCC74x_BLE_MESH_PROXY_CLIENT_REMOVE_FILTER_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_START_BLE_ADVERTISING: {
        ...
        act = QCC74x_BLE_MESH_START_BLE_ADVERTISING_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_STOP_BLE_ADVERTISING:
        act = QCC74x_BLE_MESH_STOP_BLE_ADVERTISING_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_MODEL_SUBSCRIBE_GROUP_ADDR:
        act = QCC74x_BLE_MESH_MODEL_SUBSCRIBE_GROUP_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_MODEL_UNSUBSCRIBE_GROUP_ADDR:
        act = QCC74x_BLE_MESH_MODEL_UNSUBSCRIBE_GROUP_ADDR_COMP_EVT;
    ...
    case BTC_BLE_MESH_ACT_DEINIT_MESH:
        act = QCC74x_BLE_MESH_DEINIT_MESH_COMP_EVT;
		#if 0
...
{
    qcc74x_ble_mesh_prov_cb_param_t *param = NULL;
    ...
    param = (qcc74x_ble_mesh_prov_cb_param_t *)(msg->arg);

    if (msg->act < QCC74x_BLE_MESH_PROV_EVT_MAX) {
...
void btc_ble_mesh_model_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_BLE_MESH_ACT_SERVER_MODEL_SEND: {
        ...
        struct net_buf_simple *buf = bt_mesh_alloc_buf(arg->model_send.length + QCC74x_BLE_MESH_MIC_SHORT);
        if (!buf) {
...
{
    qcc74x_ble_mesh_model_cb_param_t *param = NULL;
    ...
    param = (qcc74x_ble_mesh_model_cb_param_t *)(msg->arg);

    if (msg->act < QCC74x_BLE_MESH_MODEL_EVT_MAX) {
