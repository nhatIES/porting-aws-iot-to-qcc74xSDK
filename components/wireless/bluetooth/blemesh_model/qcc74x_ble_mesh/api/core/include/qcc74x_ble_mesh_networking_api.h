...
#ifndef _QCC74x_BLE_MESH_NETWORKING_API_H_
#define _QCC74x_BLE_MESH_NETWORKING_API_H_
...
typedef void (* qcc74x_ble_mesh_model_cb_t)(qcc74x_ble_mesh_model_cb_event_t event,
 ...
 *                  application layer;
 *                - If users call qcc74x_ble_mesh_server/client_model_send, this callback notifies the
 ...
 *                For example, qcc74x_ble_mesh_register_config_client_callback is the register
 ...
 *                      the user_data(defined using qcc74x_ble_mesh_client_t_) of the client model
 ...
 *
 * @note          This function shall be invoked before qcc74x_ble_mesh_deinit() is called.
 *
 ...
 *                publication message (@ref qcc74x_ble_mesh_model_pub_t.msg) contains a valid
 *                message to be sent. And if users want to update the publishing message,
 *                this API should be called in QCC74x_BLE_MESH_MODEL_PUBLISH_UPDATE_EVT
 ...
 * @param[in]    length: Message length (exclude the message opcode).
 * @param[in]    data: Parameters of the Access Payload (exclude the message opcode) to be sent.
 * @param[in]    device_role: Role of the device (node/provisioner) publishing the message of the type qcc74x_ble_mesh_dev_role_t.
 *
 * @return       QCC74x_OK on success or error code otherwise.
 *
 */
 ...
 *                needs to be reprovisioned. The API function qcc74x_ble_mesh_node_prov_enable()
 ...
 *
 * @note         index is obtained from the parameters of QCC74x_BLE_MESH_PROVISIONER_PROV_COMPLETE_EVT.
 *
 * @return       QCC74x_OK on success or error code otherwise.
 *
 */
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_add_local_app_key(const uint8_t app_key[16], uint16_t net_idx, uint16_t app_idx);
...
#endif /* _QCC74x_BLE_MESH_NETWORKING_API_H_ */
