...
#ifndef _QCC74x_BLE_MESH_PROVISIONING_API_H_
#define _QCC74x_BLE_MESH_PROVISIONING_API_H_
...
typedef void (* qcc74x_ble_mesh_prov_cb_t)(qcc74x_ble_mesh_prov_cb_event_t event,
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_register_prov_callback(qcc74x_ble_mesh_prov_cb_t callback);
 ...
 *
 */
bool qcc74x_ble_mesh_node_is_provisioned(void);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_node_prov_enable(qcc74x_ble_mesh_prov_bearer_t bearers);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_node_prov_disable(qcc74x_ble_mesh_prov_bearer_t bearers);
 ...
 * @return       QCC74x_OK on success or error code otherwise.
 */
qcc74x_err_t qcc74x_ble_mesh_node_set_oob_pub_key(uint8_t pub_key_x[32], uint8_t pub_key_y[32],
        uint8_t private_key[32]);

/**
 * @brief        Provide provisioning input OOB number.
 *
 * @note         This is intended to be called if the user has received QCC74x_BLE_MESH_NODE_PROV_INPUT_EVT
 *               with QCC74x_BLE_MESH_ENTER_NUMBER as the action.
 *
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_node_input_number(uint32_t number);

/**
 * @brief        Provide provisioning input OOB string.
 *
 * @note         This is intended to be called if the user has received QCC74x_BLE_MESH_NODE_PROV_INPUT_EVT
 *               with QCC74x_BLE_MESH_ENTER_STRING as the action.
 *
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_node_input_string(const char *string);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_set_unprovisioned_device_name(const char *name);
 ...
 * @return       QCC74x_OK on success or error code otherwise.
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_read_oob_pub_key(uint8_t link_idx, uint8_t pub_key_x[32],
        uint8_t pub_key_y[32]);

/**
 * @brief        Provide provisioning input OOB string.
 *
 *               This is intended to be called after the qcc74x_ble_mesh_prov_t prov_input_num
 *               callback has been called with QCC74x_BLE_MESH_ENTER_STRING as the action.
 *
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_input_string(const char *string, uint8_t link_idx);

/**
 * @brief        Provide provisioning input OOB number.
 *
 *               This is intended to be called after the qcc74x_ble_mesh_prov_t prov_input_num
 *               callback has been called with QCC74x_BLE_MESH_ENTER_NUMBER as the action.
 *
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_input_number(uint32_t number, uint8_t link_idx);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_prov_enable(qcc74x_ble_mesh_prov_bearer_t bearers);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_prov_disable(qcc74x_ble_mesh_prov_bearer_t bearers);
 ...
 *                    QCC74x_BLE_MESH_PROV_ADV and QCC74x_BLE_MESH_PROV_GATT enabled, and cannot set flags
 ...
 *                  qcc74x_ble_mesh_register_prov_callback. And in the callback, the Provisioner
 ...
 *                    device address can be added, bearers shall be set with QCC74x_BLE_MESH_PROV_ADV
 ...
 *                    address need to be added, bearers shall be set with QCC74x_BLE_MESH_PROV_GATT enabled,
 ...
 *                    of QCC74x_BLE_MESH_PROV_ADV and QCC74x_BLE_MESH_PROV_GATT enabled (recommend to enable the
 ...
 *                  - Note: QCC74x_BLE_MESH_PROV_ADV, QCC74x_BLE_MESH_PROV_GATT and ADD_DEV_START_PROV_NOW_FLAG
 *                          can not be enabled at the same time.
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_add_unprov_dev(qcc74x_ble_mesh_unprov_dev_add_t *add_dev,
 ...
 *
 *  @note: 1. Currently address type only supports public address and static random address.
 *         2. Bearer must be equal to QCC74x_BLE_MESH_PROV_ADV or QCC74x_BLE_MESH_PROV_GATT, since
 ...
 *            of the QCC74x_BLE_MESH_PROVISIONER_RECV_UNPROV_ADV_PKT_EVT event.
 ...
 *         4. Recommend to use only one of the functions "qcc74x_ble_mesh_provisioner_add_unprov_dev"
 *            and "qcc74x_ble_mesh_provisioner_prov_device_with_addr" by a Provisioner.
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_prov_device_with_addr(const uint8_t uuid[16],
            qcc74x_ble_mesh_bd_addr_t addr, qcc74x_ble_mesh_addr_type_t addr_type,
            qcc74x_ble_mesh_prov_bearer_t bearer, uint16_t oob_info, uint16_t unicast_addr);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_delete_dev(qcc74x_ble_mesh_device_delete_t *del_dev);
 ...
 *
 */
typedef void (*qcc74x_ble_mesh_prov_adv_cb_t)(const qcc74x_ble_mesh_bd_addr_t addr, const qcc74x_ble_mesh_addr_type_t addr_type,
        const uint8_t adv_type, const uint8_t *dev_uuid,
        uint16_t oob_info, qcc74x_ble_mesh_prov_bearer_t bearer);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_set_dev_uuid_match(const uint8_t *match_val, uint8_t match_len,
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_set_prov_data_info(qcc74x_ble_mesh_prov_data_info_t *prov_data_info);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_set_static_oob_value(const uint8_t *value, uint8_t length);
 ...
 *                qcc74x_ble_mesh_prov_t will be ignored, and Provisioner will use this address as its
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_provisioner_set_primary_elem_addr(uint16_t addr);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_set_fast_prov_info(qcc74x_ble_mesh_fast_prov_info_t *fast_prov_info);
 ...
 *
 */
qcc74x_err_t qcc74x_ble_mesh_set_fast_prov_action(qcc74x_ble_mesh_fast_prov_action_t action);

#ifdef __cplusplus
}
#endif

#endif /* _QCC74x_BLE_MESH_PROVISIONING_API_H_ */
