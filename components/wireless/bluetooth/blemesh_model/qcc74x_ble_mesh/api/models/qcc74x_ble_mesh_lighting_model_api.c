...
qcc74x_err_t qcc74x_ble_mesh_register_light_client_callback(qcc74x_ble_mesh_light_client_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_LIGHTING_CLIENT, callback) == 0 ? QCC74x_OK : QCC74x_FAIL);
}
        ...
        qcc74x_ble_mesh_light_client_get_state_t *get_state)
{
    ...
    if (params == NULL || params->model == NULL ||
        ...
        (params->opcode == QCC74x_BLE_MESH_MODEL_OP_LIGHT_LC_PROPERTY_GET && get_state == NULL)) {
...
qcc74x_err_t qcc74x_ble_mesh_register_lighting_server_callback(qcc74x_ble_mesh_lighting_server_cb_t callback)
{
    ...
    return (btc_profile_cb_set(BTC_PID_LIGHTING_SERVER, callback) == 0 ? QCC74x_OK : QCC74x_FAIL);
}
