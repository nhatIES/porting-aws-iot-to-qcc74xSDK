...
#ifndef _QCC74x_BLE_MESH_GENERIC_MODEL_API_H_
#define _QCC74x_BLE_MESH_GENERIC_MODEL_API_H_
...
/** @def    QCC74x_BLE_MESH_MODEL_GEN_ONOFF_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_ONOFF_CLI(cli_pub, cli_data)         \
		BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_ONOFF_CLI, NULL, cli_pub,   \
						 cli_data, &bt_mesh_gen_onoff_cli_cb)



/** @def    QCC74x_BLE_MESH_MODEL_GEN_LEVEL_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_LEVEL_CLI(cli_pub, cli_data)         \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_LEVEL_CLI, NULL, cli_pub,   \
						 cli_data, &bt_mesh_gen_level_cli_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_CLI(cli_pub, cli_data)            \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_CLI,NULL, cli_pub,    \
                    cli_data, &bt_mesh_gen_def_trans_time_cli_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_CLI(cli_pub, cli_data)           \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_CLI, NULL, cli_pub,   \
						 cli_data, &bt_mesh_gen_pwr_onoff_cli_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_CLI(cli_pub, cli_data)           \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_CLI,   \
                    NULL, cli_pub, cli_data, &bt_mesh_gen_pwr_level_cli_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_BATTERY_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_BATTERY_CLI(cli_pub, cli_data)           \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_BATTERY_CLI,   \
                    NULL, cli_pub, cli_data, &bt_mesh_gen_battery_cli_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_LOCATION_CLI
 *
 ...
 */
#define QCC74x_BLE_MESH_MODEL_GEN_LOCATION_CLI(cli_pub, cli_data)          \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_LOCATION_CLI,  \
                    NULL, cli_pub, cli_data, &bt_mesh_gen_location_cli_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_PROPERTY_CLI
 *
 ...
 *  @return New Generic Location Client Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_PROPERTY_CLI(cli_pub, cli_data)          \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_PROP_CLI,      \
...
} qcc74x_ble_mesh_gen_onoff_set_t;
...
typedef struct {
    ...
    uint8_t trans_time; /*!< Time to complete state transition (optional) */
    uint8_t delay;      /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_gen_level_set_t;
...
typedef struct {
    ...
    uint8_t trans_time; /*!< Time to complete state transition (optional) */
    uint8_t delay;      /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_gen_delta_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_gen_move_set_t;
...
} qcc74x_ble_mesh_gen_power_range_set_t;
...
} qcc74x_ble_mesh_gen_loc_global_set_t;
...
} qcc74x_ble_mesh_gen_admin_property_set_t;
...
} qcc74x_ble_mesh_gen_manufacturer_property_get_t;

/** Parameters of Generic Manufacturer Property Set. */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Manufacturer Property */
    uint8_t  user_access;   /*!< Enumeration indicating user access */
} qcc74x_ble_mesh_gen_manufacturer_property_set_t;

/** Parameter of Generic Client Properties Get. */
typedef struct {
    uint16_t property_id;   /*!< A starting Client Property ID present within an element */
} qcc74x_ble_mesh_gen_client_properties_get_t;

/**
 * @brief Generic Client Model get message union
 */
typedef union {
    qcc74x_ble_mesh_gen_user_property_get_t         user_property_get;         /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_GET */
    qcc74x_ble_mesh_gen_admin_property_get_t        admin_property_get;        /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_GET*/
    qcc74x_ble_mesh_gen_manufacturer_property_get_t manufacturer_property_get; /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET */
    qcc74x_ble_mesh_gen_client_properties_get_t     client_properties_get;     /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_CLIENT_PROPERTIES_GET */
} qcc74x_ble_mesh_generic_client_get_state_t;

/**
 * @brief Generic Client Model set message union
 */
typedef union {
    qcc74x_ble_mesh_gen_onoff_set_t          onoff_set;            /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_SET_UNACK */
    qcc74x_ble_mesh_gen_level_set_t          level_set;            /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_SET_UNACK */
    qcc74x_ble_mesh_gen_delta_set_t          delta_set;            /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_DELTA_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_DELTA_SET_UNACK */
    qcc74x_ble_mesh_gen_move_set_t           move_set;             /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_MOVE_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_MOVE_SET_UNACK */
    qcc74x_ble_mesh_gen_def_trans_time_set_t def_trans_time_set;   /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_SET_UNACK */
    qcc74x_ble_mesh_gen_onpowerup_set_t      power_set;            /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_SET_UNACK */
    qcc74x_ble_mesh_gen_power_level_set_t    power_level_set;      /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_SET_UNACK */
    qcc74x_ble_mesh_gen_power_default_set_t  power_default_set;    /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_SET_UNACK */
    qcc74x_ble_mesh_gen_power_range_set_t    power_range_set;      /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_SET_UNACK */
    qcc74x_ble_mesh_gen_loc_global_set_t     loc_global_set;       /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_SET_UNACK */
    qcc74x_ble_mesh_gen_loc_local_set_t      loc_local_set;        /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_SET_UNACK */
    qcc74x_ble_mesh_gen_user_property_set_t  user_property_set;    /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_SET_UNACK */
    qcc74x_ble_mesh_gen_admin_property_set_t admin_property_set;   /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_SET_UNACK */
    qcc74x_ble_mesh_gen_manufacturer_property_set_t manufacturer_property_set; /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET & QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_SET_UNACK */
} qcc74x_ble_mesh_generic_client_set_state_t;
...
} qcc74x_ble_mesh_gen_onoff_status_cb_t;
...
typedef struct {
    ...
    uint8_t remain_time;    /*!< Time to complete state transition (C.1) */
} qcc74x_ble_mesh_gen_level_status_cb_t;

/** Parameter of Generic Default Transition Time Status. */
typedef struct {
    uint8_t trans_time;     /*!< The value of the Generic Default Transition Time state */
} qcc74x_ble_mesh_gen_def_trans_time_status_cb_t;

/** Parameter of Generic OnPowerUp Status. */
typedef struct {
    uint8_t onpowerup;      /*!< The value of the Generic OnPowerUp state */
} qcc74x_ble_mesh_gen_onpowerup_status_cb_t;
...
typedef struct {
    ...
    uint16_t range_min;     /*!< Value of Range Min field of Generic Power Range state */
    uint16_t range_max;     /*!< Value of Range Max field of Generic Power Range state */
} qcc74x_ble_mesh_gen_power_range_status_cb_t;
...
} qcc74x_ble_mesh_gen_battery_status_cb_t;
...
typedef struct {
    ...
    int32_t global_longitude; /*!< Global Coordinates (Longitude) */
    int16_t global_altitude;  /*!< Global Altitude */
} qcc74x_ble_mesh_gen_loc_global_status_cb_t;
...
typedef struct {
    ...
    uint8_t  floor_number;    /*!< Floor Number */
    uint16_t uncertainty;     /*!< Uncertainty */
} qcc74x_ble_mesh_gen_loc_local_status_cb_t;
...
} qcc74x_ble_mesh_gen_user_properties_status_cb_t;
...
} qcc74x_ble_mesh_gen_user_property_status_cb_t;
...
} qcc74x_ble_mesh_gen_admin_properties_status_cb_t;
...
} qcc74x_ble_mesh_gen_admin_property_status_cb_t;
...
} qcc74x_ble_mesh_gen_manufacturer_properties_status_cb_t;
...
} qcc74x_ble_mesh_gen_manufacturer_property_status_cb_t;
...
} qcc74x_ble_mesh_gen_client_properties_status_cb_t;

/**
 * @brief Generic Client Model received message union
 */
typedef union {
    qcc74x_ble_mesh_gen_onoff_status_cb_t             onoff_status;            /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_ONOFF_STATUS */
    qcc74x_ble_mesh_gen_level_status_cb_t             level_status;            /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_LEVEL_STATUS */
    qcc74x_ble_mesh_gen_def_trans_time_status_cb_t    def_trans_time_status;   /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_DEF_TRANS_TIME_STATUS */
    qcc74x_ble_mesh_gen_onpowerup_status_cb_t         onpowerup_status;        /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_ONPOWERUP_STATUS */
    qcc74x_ble_mesh_gen_power_level_status_cb_t       power_level_status;      /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LEVEL_STATUS */
    qcc74x_ble_mesh_gen_power_last_status_cb_t        power_last_status;       /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_LAST_STATUS */
    qcc74x_ble_mesh_gen_power_default_status_cb_t     power_default_status;    /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_DEFAULT_STATUS */
    qcc74x_ble_mesh_gen_power_range_status_cb_t       power_range_status;      /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_POWER_RANGE_STATUS */
    qcc74x_ble_mesh_gen_battery_status_cb_t           battery_status;          /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_BATTERY_STATUS */
    qcc74x_ble_mesh_gen_loc_global_status_cb_t        location_global_status;  /*!< For QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_GLOBAL_STATUS */
    qcc74x_ble_mesh_gen_loc_local_status_cb_t         location_local_status;   /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_LOC_LOCAL_STATUS */
    qcc74x_ble_mesh_gen_user_properties_status_cb_t   user_properties_status;  /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTIES_STATUS */
    qcc74x_ble_mesh_gen_user_property_status_cb_t     user_property_status;    /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_USER_PROPERTY_STATUS */
    qcc74x_ble_mesh_gen_admin_properties_status_cb_t  admin_properties_status; /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTIES_STATUS */
    qcc74x_ble_mesh_gen_admin_property_status_cb_t    admin_property_status;   /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_ADMIN_PROPERTY_STATUS */
    qcc74x_ble_mesh_gen_manufacturer_properties_status_cb_t manufacturer_properties_status; /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTIES_STATUS */
    qcc74x_ble_mesh_gen_manufacturer_property_status_cb_t   manufacturer_property_status;   /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_MANUFACTURER_PROPERTY_STATUS */
    qcc74x_ble_mesh_gen_client_properties_status_cb_t       client_properties_status;       /*!< QCC74x_BLE_MESH_MODEL_OP_GEN_CLIENT_PROPERTIES_STATUS */
} qcc74x_ble_mesh_gen_client_status_cb_t;
...
typedef struct {
    ...
    qcc74x_ble_mesh_gen_client_status_cb_t status_cb;  /*!< The generic status message callback values */
} qcc74x_ble_mesh_generic_client_cb_param_t;

/** This enum value is the event of Generic Client Model */
typedef enum {
    QCC74x_BLE_MESH_GENERIC_CLIENT_GET_STATE_EVT,
    QCC74x_BLE_MESH_GENERIC_CLIENT_SET_STATE_EVT,
    QCC74x_BLE_MESH_GENERIC_CLIENT_PUBLISH_EVT,
    QCC74x_BLE_MESH_GENERIC_CLIENT_TIMEOUT_EVT,
    QCC74x_BLE_MESH_GENERIC_CLIENT_EVT_MAX,
} qcc74x_ble_mesh_generic_client_cb_event_t;
 ...
 */
typedef void (* qcc74x_ble_mesh_generic_client_cb_t)(qcc74x_ble_mesh_generic_client_cb_event_t event,
 ...
 *              please refer to qcc74x_ble_mesh_generic_message_opcode_t in qcc74x_ble_mesh_defs.h
 *
...
/** @def    QCC74x_BLE_MESH_MODEL_GEN_ONOFF_SRV
 *
 ...
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_onoff_srv_t.
 *
 *  @return New Generic OnOff Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_ONOFF_SRV(srv_pub, srv_data)             \
	BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_ONOFF_SRV, NULL, srv_pub,   \
			 srv_data, &bt_mesh_gen_onoff_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_LEVEL_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_level_srv_t.
 *
 *  @return New Generic Level Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_LEVEL_SRV(srv_pub, srv_data)             \
		BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_LEVEL_SRV, NULL, srv_pub,   \
					 srv_data, &bt_mesh_gen_level_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_def_trans_time_srv_t.
 *
 *  @return New Generic Default Transition Time Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_DEF_TRANS_TIME_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_DEF_TRANS_TIME_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_def_trans_time_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_power_onoff_srv_t.
 *
 *  @return New Generic Power OnOff Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_power_onoff_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_power_onoff_setup_srv_t.
 *
 *  @return New Generic Power OnOff Setup Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_POWER_ONOFF_SETUP_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_POWER_ONOFF_SETUP_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_power_onoff_setup_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_power_level_srv_t.
 *
 *  @return New Generic Power Level Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_power_level_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_power_level_setup_srv_t.
 *
 *  @return New Generic Power Level Setup Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_POWER_LEVEL_SETUP_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_POWER_LEVEL_SETUP_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_power_level_setup_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_BATTERY_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_battery_srv_t.
 *
 *  @return New Generic Battery Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_BATTERY_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_BATTERY_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_battery_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_LOCATION_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_location_srv_t.
 *
 *  @return New Generic Location Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_LOCATION_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_LOCATION_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_location_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_LOCATION_SETUP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_location_setup_srv_t.
 *
 *  @return New Generic Location Setup Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_LOCATION_SETUP_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_LOCATION_SETUP_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_location_setup_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_USER_PROP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_user_prop_srv_t.
 *
 *  @return New Generic User Property Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_USER_PROP_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_USER_PROP_SRV,     \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_user_prop_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_ADMIN_PROP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_admin_prop_srv_t.
 *
 *  @return New Generic Admin Property Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_ADMIN_PROP_SRV(srv_pub, srv_data)            \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_ADMIN_PROP_SRV,    \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_admin_prop_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_MANUFACTURER_PROP_SRV
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_manu_prop_srv_t.
 *
 *  @return New Generic Manufacturer Property Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_MANUFACTURER_PROP_SRV(srv_pub, srv_data)            \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_MANUFACTURER_PROP_SRV,    \
                    NULL, srv_pub, srv_data, &bt_mesh_gen_manu_prop_srv_cb)

/** @def    QCC74x_BLE_MESH_MODEL_GEN_CLIENT_PROP_SRV
 *
 *  @brief  Define a new Generic User Property Server Model.
 *
 ...
 *
 *  @param  srv_pub  Pointer to the unique struct qcc74x_ble_mesh_model_pub_t.
 *  @param  srv_data Pointer to the unique struct qcc74x_ble_mesh_gen_client_prop_srv_t.
 *
 *  @return New Generic Client Property Server Model instance.
 */
#define QCC74x_BLE_MESH_MODEL_GEN_CLIENT_PROP_SRV(srv_pub, srv_data)             \
        BT_MESH_MODEL_CB(QCC74x_BLE_MESH_MODEL_ID_GEN_CLIENT_PROP_SRV,     \
...
} qcc74x_ble_mesh_gen_onoff_state_t;

/** User data of Generic OnOff Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic OnOff Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_onoff_state_t state;       /*!< Parameters of the Generic OnOff state */
...
} qcc74x_ble_mesh_gen_onoff_srv_t;
...
} qcc74x_ble_mesh_gen_level_state_t;

/** User data of Generic Level Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Level Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_level_state_t state;       /*!< Parameters of the Generic Level state */
    qcc74x_ble_mesh_last_msg_info_t last;          /*!< Parameters of the last received set message */
    qcc74x_ble_mesh_state_transition_t transition; /*!< Parameters of state transition */
    int32_t tt_delta_level;                     /*!< Delta change value of level state transition */
} qcc74x_ble_mesh_gen_level_srv_t;

/** Parameter of Generic Default Transition Time state */
typedef struct {
    uint8_t trans_time;     /*!< The value of the Generic Default Transition Time state */
} qcc74x_ble_mesh_gen_def_trans_time_state_t;

/** User data of Generic Default Transition Time Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Default Transition Time Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_def_trans_time_state_t state;  /*!< Parameters of the Generic Default Transition Time state */
} qcc74x_ble_mesh_gen_def_trans_time_srv_t;

/** Parameter of Generic OnPowerUp state */
typedef struct {
    uint8_t onpowerup;      /*!< The value of the Generic OnPowerUp state */
} qcc74x_ble_mesh_gen_onpowerup_state_t;

/** User data of Generic Power OnOff Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Power OnOff Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_onpowerup_state_t *state;  /*!< Parameters of the Generic OnPowerUp state */
} qcc74x_ble_mesh_gen_power_onoff_srv_t;

/** User data of Generic Power OnOff Setup Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Power OnOff Setup Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_onpowerup_state_t *state;  /*!< Parameters of the Generic OnPowerUp state */
} qcc74x_ble_mesh_gen_power_onoff_setup_srv_t;
...
} qcc74x_ble_mesh_gen_power_level_state_t;

/** User data of Generic Power Level Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Power Level Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_power_level_state_t *state;    /*!< Parameters of the Generic Power Level state */
    qcc74x_ble_mesh_last_msg_info_t last;              /*!< Parameters of the last received set message */
    qcc74x_ble_mesh_state_transition_t transition;     /*!< Parameters of state transition */
    int32_t tt_delta_level;                         /*!< Delta change value of level state transition */
} qcc74x_ble_mesh_gen_power_level_srv_t;

/** User data of Generic Power Level Setup Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Power Level Setup Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_power_level_state_t *state;    /*!< Parameters of the Generic Power Level state */
} qcc74x_ble_mesh_gen_power_level_setup_srv_t;
...
} qcc74x_ble_mesh_gen_battery_state_t;

/** User data of Generic Battery Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Battery Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_battery_state_t state;     /*!< Parameters of the Generic Battery state */
} qcc74x_ble_mesh_gen_battery_srv_t;
...
} qcc74x_ble_mesh_gen_location_state_t;

/** User data of Generic Location Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Location Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_location_state_t *state;   /*!< Parameters of the Generic Location state */
} qcc74x_ble_mesh_gen_location_srv_t;

/** User data of Generic Location Setup Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Location Setup Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    qcc74x_ble_mesh_gen_location_state_t *state;   /*!< Parameters of the Generic Location state */
} qcc74x_ble_mesh_gen_location_setup_srv_t;

/** This enum value is the access value of Generic User Property */
typedef enum {
    QCC74x_BLE_MESH_GEN_USER_ACCESS_PROHIBIT,
    QCC74x_BLE_MESH_GEN_USER_ACCESS_READ,
    QCC74x_BLE_MESH_GEN_USER_ACCESS_WRITE,
    QCC74x_BLE_MESH_GEN_USER_ACCESS_READ_WRITE,
} qcc74x_ble_mesh_gen_user_prop_access_t;

/** This enum value is the access value of Generic Admin Property */
typedef enum {
    QCC74x_BLE_MESH_GEN_ADMIN_NOT_USER_PROP,
    QCC74x_BLE_MESH_GEN_ADMIN_ACCESS_READ,
    QCC74x_BLE_MESH_GEN_ADMIN_ACCESS_WRITE,
    QCC74x_BLE_MESH_GEN_ADMIN_ACCESS_READ_WRITE,
} qcc74x_ble_mesh_gen_admin_prop_access_t;

/** This enum value is the access value of Generic Manufacturer Property */
typedef enum {
    QCC74x_BLE_MESH_GEN_MANU_NOT_USER_PROP,
    QCC74x_BLE_MESH_GEN_MANU_ACCESS_READ,
} qcc74x_ble_mesh_gen_manu_prop_access_t;
...
} qcc74x_ble_mesh_generic_property_t;

/** User data of Generic User Property Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                    /*!< Pointer to the Generic User Property Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    uint8_t property_count;                         /*!< Generic User Property count */
    qcc74x_ble_mesh_generic_property_t *properties;    /*!< Parameters of the Generic User Property state */
} qcc74x_ble_mesh_gen_user_prop_srv_t;

/** User data of Generic Admin Property Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Admin Property Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    uint8_t property_count;                         /*!< Generic Admin Property count */
    qcc74x_ble_mesh_generic_property_t *properties;    /*!< Parameters of the Generic Admin Property state */
} qcc74x_ble_mesh_gen_admin_prop_srv_t;

/** User data of Generic Manufacturer Property Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                    /*!< Pointer to the Generic Manufacturer Property Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;        /*!< Response control of the server model received messages */
    uint8_t property_count;                         /*!< Generic Manufacturer Property count */
    qcc74x_ble_mesh_generic_property_t *properties;    /*!< Parameters of the Generic Manufacturer Property state */
} qcc74x_ble_mesh_gen_manu_prop_srv_t;

/** User data of Generic Client Property Server Model */
typedef struct {
    qcc74x_ble_mesh_model_t *model;                /*!< Pointer to the Generic Client Property Server Model. Initialized internally. */
    qcc74x_ble_mesh_server_rsp_ctrl_t rsp_ctrl;    /*!< Response control of the server model received messages */
    uint8_t id_count;                           /*!< Generic Client Property ID count */
    uint16_t *property_ids;                     /*!< Parameters of the Generic Client Property state */
} qcc74x_ble_mesh_gen_client_prop_srv_t;

/** Parameter of Generic OnOff Set state change event */
typedef struct {
    uint8_t onoff;          /*!< The value of Generic OnOff state */
} qcc74x_ble_mesh_state_change_gen_onoff_set_t;

/** Parameter of Generic Level Set state change event */
typedef struct {
    int16_t level;          /*!< The value of Generic Level state */
} qcc74x_ble_mesh_state_change_gen_level_set_t;

/** Parameter of Generic Delta Set state change event */
typedef struct {
    int16_t level;          /*!< The value of Generic Level state */
} qcc74x_ble_mesh_state_change_gen_delta_set_t;

/** Parameter of Generic Move Set state change event */
typedef struct {
    int16_t level;          /*!< The value of Generic Level state */
} qcc74x_ble_mesh_state_change_gen_move_set_t;
...
} qcc74x_ble_mesh_state_change_gen_power_range_set_t;
...
} qcc74x_ble_mesh_state_change_gen_loc_global_set_t;
...
} qcc74x_ble_mesh_state_change_gen_loc_local_set_t;
...
} qcc74x_ble_mesh_state_change_gen_user_property_set_t;
...
} qcc74x_ble_mesh_state_change_gen_admin_property_set_t;
...
} qcc74x_ble_mesh_state_change_gen_manu_property_set_t;
...
typedef union {
     ...
     */
    qcc74x_ble_mesh_state_change_gen_onoff_set_t          onoff_set;           /*!< Generic OnOff Set */
    qcc74x_ble_mesh_state_change_gen_level_set_t          level_set;           /*!< Generic Level Set */
    qcc74x_ble_mesh_state_change_gen_delta_set_t          delta_set;           /*!< Generic Delta Set */
    qcc74x_ble_mesh_state_change_gen_move_set_t           move_set;            /*!< Generic Move Set */
    qcc74x_ble_mesh_state_change_gen_def_trans_time_set_t def_trans_time_set;  /*!< Generic Default Transition Time Set */
    qcc74x_ble_mesh_state_change_gen_onpowerup_set_t      onpowerup_set;       /*!< Generic OnPowerUp Set */
    qcc74x_ble_mesh_state_change_gen_power_level_set_t    power_level_set;     /*!< Generic Power Level Set */
    qcc74x_ble_mesh_state_change_gen_power_default_set_t  power_default_set;   /*!< Generic Power Default Set */
    qcc74x_ble_mesh_state_change_gen_power_range_set_t    power_range_set;     /*!< Generic Power Range Set */
    qcc74x_ble_mesh_state_change_gen_loc_global_set_t     loc_global_set;      /*!< Generic Location Global Set */
    qcc74x_ble_mesh_state_change_gen_loc_local_set_t      loc_local_set;       /*!< Generic Location Local Set */
    qcc74x_ble_mesh_state_change_gen_user_property_set_t  user_property_set;   /*!< Generic User Property Set */
    qcc74x_ble_mesh_state_change_gen_admin_property_set_t admin_property_set;  /*!< Generic Admin Property Set */
    qcc74x_ble_mesh_state_change_gen_manu_property_set_t  manu_property_set;   /*!< Generic Manufacturer Property Set */
} qcc74x_ble_mesh_generic_server_state_change_t;

/** Context of the received Generic User Property Get message */
typedef struct {
    uint16_t property_id;       /*!< Property ID identifying a Generic User Property */
} qcc74x_ble_mesh_server_recv_gen_user_property_get_t;

/** Context of the received Generic Admin Property Get message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Admin Property */
} qcc74x_ble_mesh_server_recv_gen_admin_property_get_t;

/** Context of the received Generic Manufacturer Property message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Manufacturer Property */
} qcc74x_ble_mesh_server_recv_gen_manufacturer_property_get_t;

/** Context of the received Generic Client Properties Get message */
typedef struct {
    uint16_t property_id;   /*!< A starting Client Property ID present within an element */
} qcc74x_ble_mesh_server_recv_gen_client_properties_get_t;

/**
 * @brief Generic Server Model received get message union
 */
typedef union {
    qcc74x_ble_mesh_server_recv_gen_user_property_get_t         user_property;     /*!< Generic User Property Get */
    qcc74x_ble_mesh_server_recv_gen_admin_property_get_t        admin_property;    /*!< Generic Admin Property Get */
    qcc74x_ble_mesh_server_recv_gen_manufacturer_property_get_t manu_property;     /*!< Generic Manufacturer Property Get */
    qcc74x_ble_mesh_server_recv_gen_client_properties_get_t     client_properties; /*!< Generic Client Properties Get */
} qcc74x_ble_mesh_generic_server_recv_get_msg_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_server_recv_gen_onoff_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_server_recv_gen_level_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_server_recv_gen_delta_set_t;
...
typedef struct {
    ...
    uint8_t trans_time;     /*!< Time to complete state transition (optional) */
    uint8_t delay;          /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_server_recv_gen_move_set_t;

/** Context of the received Generic Default Transition Time Set message */
typedef struct {
    uint8_t trans_time;     /*!< The value of the Generic Default Transition Time state */
} qcc74x_ble_mesh_server_recv_gen_def_trans_time_set_t;

/** Context of the received Generic OnPowerUp Set message */
typedef struct {
    uint8_t onpowerup;      /*!< The value of the Generic OnPowerUp state */
} qcc74x_ble_mesh_server_recv_gen_onpowerup_set_t;
...
typedef struct {
    ...
    uint8_t  trans_time;    /*!< Time to complete state transition (optional) */
    uint8_t  delay;         /*!< Indicate message execution delay (C.1) */
} qcc74x_ble_mesh_server_recv_gen_power_level_set_t;

/** Context of the received Generic Power Default Set message */
typedef struct {
    uint16_t power;         /*!< The value of the Generic Power Default state */
} qcc74x_ble_mesh_server_recv_gen_power_default_set_t;

/** Context of the received Generic Power Range Set message */
typedef struct {
    uint16_t range_min;     /*!< Value of Range Min field of Generic Power Range state */
    uint16_t range_max;     /*!< Value of Range Max field of Generic Power Range state */
} qcc74x_ble_mesh_server_recv_gen_power_range_set_t;
...
typedef struct {
    ...
    int32_t global_longitude;   /*!< Global Coordinates (Longitude) */
    int16_t global_altitude;    /*!< Global Altitude */
} qcc74x_ble_mesh_server_recv_gen_loc_global_set_t;
...
typedef struct {
    ...
    uint8_t  floor_number;      /*!< Floor Number */
    uint16_t uncertainty;       /*!< Uncertainty */
} qcc74x_ble_mesh_server_recv_gen_loc_local_set_t;

/** Context of the received Generic User Property Set message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic User Property */
    struct net_buf_simple *property_value;  /*!< Raw value for the User Property */
} qcc74x_ble_mesh_server_recv_gen_user_property_set_t;
...
typedef struct {
    ...
    uint8_t  user_access;   /*!< Enumeration indicating user access */
    struct net_buf_simple *property_value;  /*!< Raw value for the Admin Property */
} qcc74x_ble_mesh_server_recv_gen_admin_property_set_t;

/** Context of the received Generic Manufacturer Property Set message */
typedef struct {
    uint16_t property_id;   /*!< Property ID identifying a Generic Manufacturer Property */
    uint8_t  user_access;   /*!< Enumeration indicating user access */
} qcc74x_ble_mesh_server_recv_gen_manufacturer_property_set_t;

/**
 * @brief Generic Server Model received set message union
 */
typedef union {
    qcc74x_ble_mesh_server_recv_gen_onoff_set_t                 onoff;             /*!< Generic OnOff Set/Generic OnOff Set Unack */
    qcc74x_ble_mesh_server_recv_gen_level_set_t                 level;             /*!< Generic Level Set/Generic Level Set Unack */
    qcc74x_ble_mesh_server_recv_gen_delta_set_t                 delta;             /*!< Generic Delta Set/Generic Delta Set Unack */
    qcc74x_ble_mesh_server_recv_gen_move_set_t                  move;              /*!< Generic Move Set/Generic Move Set Unack */
    qcc74x_ble_mesh_server_recv_gen_def_trans_time_set_t        def_trans_time;    /*!< Generic Default Transition Time Set/Generic Default Transition Time Set Unack */
    qcc74x_ble_mesh_server_recv_gen_onpowerup_set_t             onpowerup;         /*!< Generic OnPowerUp Set/Generic OnPowerUp Set Unack */
    qcc74x_ble_mesh_server_recv_gen_power_level_set_t           power_level;       /*!< Generic Power Level Set/Generic Power Level Set Unack */
    qcc74x_ble_mesh_server_recv_gen_power_default_set_t         power_default;     /*!< Generic Power Default Set/Generic Power Default Set Unack */
    qcc74x_ble_mesh_server_recv_gen_power_range_set_t           power_range;       /*!< Generic Power Range Set/Generic Power Range Set Unack */
    qcc74x_ble_mesh_server_recv_gen_loc_global_set_t            location_global;   /*!< Generic Location Global Set/Generic Location Global Set Unack */
    qcc74x_ble_mesh_server_recv_gen_loc_local_set_t             location_local;    /*!< Generic Location Local Set/Generic Location Local Set Unack */
    qcc74x_ble_mesh_server_recv_gen_user_property_set_t         user_property;     /*!< Generic User Property Set/Generic User Property Set Unack */
    qcc74x_ble_mesh_server_recv_gen_admin_property_set_t        admin_property;    /*!< Generic Admin Property Set/Generic Admin Property Set Unack */
    qcc74x_ble_mesh_server_recv_gen_manufacturer_property_set_t manu_property;     /*!< Generic Manufacturer Property Set/Generic Manufacturer Property Set Unack */
} qcc74x_ble_mesh_generic_server_recv_set_msg_t;

/**
 * @brief Generic Server Model callback value union
 */
typedef union {
    qcc74x_ble_mesh_generic_server_state_change_t state_change;    /*!< QCC74x_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT */
    qcc74x_ble_mesh_generic_server_recv_get_msg_t get;     /*!< QCC74x_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT */
    qcc74x_ble_mesh_generic_server_recv_set_msg_t set;     /*!< QCC74x_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT */
} qcc74x_ble_mesh_generic_server_cb_value_t;

/** Generic Server Model callback parameters */
typedef struct {
    qcc74x_ble_mesh_model_t  *model;   /*!< Pointer to Generic Server Models */
    qcc74x_ble_mesh_msg_ctx_t ctx;     /*!< Context of the received messages */
    qcc74x_ble_mesh_generic_server_cb_value_t value;   /*!< Value of the received Generic Messages */
} qcc74x_ble_mesh_generic_server_cb_param_t;
...
typedef enum {
     ...
     *    are received.
     */
    QCC74x_BLE_MESH_GENERIC_SERVER_STATE_CHANGE_EVT,
    /**
     * When get_auto_rsp is set to QCC74x_BLE_MESH_SERVER_RSP_BY_APP, this event will be
     * callback to the application layer when Generic Get messages are received.
     */
    QCC74x_BLE_MESH_GENERIC_SERVER_RECV_GET_MSG_EVT,
    /**
     ...
     */
    QCC74x_BLE_MESH_GENERIC_SERVER_RECV_SET_MSG_EVT,
    QCC74x_BLE_MESH_GENERIC_SERVER_EVT_MAX,
} qcc74x_ble_mesh_generic_server_cb_event_t;
 ...
 * @param   param: Pointer to callback parameter
 */
typedef void (* qcc74x_ble_mesh_generic_server_cb_t)(qcc74x_ble_mesh_generic_server_cb_event_t event,
...
#endif /* _QCC74x_BLE_MESH_GENERIC_MODEL_API_H_ */
