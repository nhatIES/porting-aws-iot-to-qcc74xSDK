                                 ...
                                 bt_mesh_server_state_value_t *value)
{
    ...
    case GENERIC_ONOFF_STATE: {
        if (model->id != BT_MESH_MODEL_ID_GEN_ONOFF_SRV) {
    ...
    case GENERIC_ONPOWERUP_STATE: {
        if (model->id != BT_MESH_MODEL_ID_GEN_POWER_ONOFF_SRV) {
    ...
    case LIGHT_CTL_TEMP_DELTA_UV_STATE: {
        if (model->id != BT_MESH_MODEL_ID_LIGHT_CTL_TEMP_SRV) {
    ...
    case LIGHT_HSL_HUE_STATE: {
        if (model->id != BT_MESH_MODEL_ID_LIGHT_HSL_HUE_SRV) {
    ...
    case LIGHT_HSL_SATURATION_STATE: {
        if (model->id != BT_MESH_MODEL_ID_LIGHT_HSL_SAT_SRV) {
