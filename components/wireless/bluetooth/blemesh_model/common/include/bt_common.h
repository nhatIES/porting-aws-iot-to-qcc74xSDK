...
// Mapping between QCC74x_LOG_LEVEL and BT_TRACE_LEVEL
...
#define BT_PRINT_E(tag, format, ...)   {qcc74x_log_write(QCC74x_LOG_ERROR,   tag, LOG_FORMAT(E, format), qcc74x_log_timestamp(), tag, ##__VA_ARGS__); }
#define BT_PRINT_W(tag, format, ...)   {qcc74x_log_write(QCC74x_LOG_WARN,    tag, LOG_FORMAT(W, format), qcc74x_log_timestamp(), tag, ##__VA_ARGS__); }
#define BT_PRINT_I(tag, format, ...)   {qcc74x_log_write(QCC74x_LOG_INFO,    tag, LOG_FORMAT(I, format), qcc74x_log_timestamp(), tag, ##__VA_ARGS__); }
#define BT_PRINT_D(tag, format, ...)   {qcc74x_log_write(QCC74x_LOG_DEBUG,   tag, LOG_FORMAT(D, format), qcc74x_log_timestamp(), tag, ##__VA_ARGS__); }
#define BT_PRINT_V(tag, format, ...)   {qcc74x_log_write(QCC74x_LOG_VERBOSE, tag, LOG_FORMAT(V, format), qcc74x_log_timestamp(), tag, ##__VA_ARGS__); }
...
/* relate to QCC74x_BT_STATUS_xxx in qcc74x_bt_defs.h */
typedef enum {
    BT_STATUS_SUCCESS = 0,
    BT_STATUS_FAIL,
    BT_STATUS_NOT_READY,
