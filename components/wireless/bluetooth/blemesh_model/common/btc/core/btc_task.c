...
#if GATTS_INCLUDED == TRUE && GATT_DYNAMIC_MEMORY == TRUE
    if ((btc_creat_tab_env_ptr = (qcc74x_btc_creat_tab_t *)osi_malloc(sizeof(qcc74x_btc_creat_tab_t))) == NULL) {
        goto error_exit;
    }
    memset((void *)btc_creat_tab_env_ptr, 0, sizeof(qcc74x_btc_creat_tab_t));
