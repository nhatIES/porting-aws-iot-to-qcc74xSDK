...
rnm_cmd_desc_t rnm_cmd_desc[QC_CMD_MAX] = {
    MAKE_DESC(QC_CMD_REBOOT),
    MAKE_DESC(QC_CMD_RESET),
    MAKE_DESC(QC_CMD_HELLO),
    MAKE_DESC(QC_CMD_PING),
    MAKE_DESC(QC_CMD_GET_MAC_ADDR),
    MAKE_DESC(QC_CMD_SCAN),
    MAKE_DESC(QC_CMD_STA_CONNECT),
    MAKE_DESC(QC_CMD_STA_DISCONNECT),
    MAKE_DESC(QC_CMD_STA_CONNECTED_IND),
    MAKE_DESC(QC_CMD_STA_DISCONNECTED_IND),
    MAKE_DESC(QC_CMD_STA_IP_UPDATE_IND),
    MAKE_DESC(QC_CMD_STA_SET_AUTO_RECONNECT),
    MAKE_DESC(QC_CMD_STA_GET_LINK_STATUS),
    MAKE_DESC(QC_CMD_AP_START),
    MAKE_DESC(QC_CMD_AP_STOP),
    MAKE_DESC(QC_CMD_AP_STARTED_IND),
    MAKE_DESC(QC_CMD_AP_STOPPED_IND),
    MAKE_DESC(QC_CMD_AP_GET_STA_LIST),
    MAKE_DESC(QC_CMD_MONITOR_START),
    MAKE_DESC(QC_CMD_MONITOR_STOP),
    MAKE_DESC(QC_CMD_MONITOR_SET_CHANNEL),
    MAKE_DESC(QC_CMD_MONITOR_GET_CHANNEL),
    MAKE_DESC(QC_CMD_SET_LPM_MODE),
    MAKE_DESC(QC_CMD_GET_DEV_VERSION),
    MAKE_DESC(QC_CMD_OTA),
    MAKE_DESC(QC_CMD_EXT),
};
