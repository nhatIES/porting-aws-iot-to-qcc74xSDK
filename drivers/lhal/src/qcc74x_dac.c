...
#ifdef romapi_qcc74x_dac_init
    romapi_qcc74x_dac_init(dev, clk_div);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_dac_channel_enable
    romapi_qcc74x_dac_channel_enable(dev, ch);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_dac_channel_disable
    romapi_qcc74x_dac_channel_disable(dev, ch);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_dac_link_txdma
    romapi_qcc74x_dac_link_txdma(dev, enable);
#else
    uint32_t regval1;
    uint32_t regval2;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_dac_set_dma_format
    romapi_qcc74x_dac_set_dma_format(dev, format);
#else
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dac_set_value
    romapi_qcc74x_dac_set_value(dev, ch, value);
#else
    uint32_t regval;
    uint32_t reg_base;
