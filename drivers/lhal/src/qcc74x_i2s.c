...
void qcc74x_i2s_init(struct qcc74x_device_s *dev, const struct qcc74x_i2s_config_s *config)
{
...
#ifdef romapi_qcc74x_i2s_init
    romapi_qcc74x_i2s_init(dev, config);
#else
    uint32_t reg_base;
    uint32_t regval;
    uint32_t div;
    ...
    div = (qcc74x_clk_get_peripheral_clock(QCC74x_DEVICE_TYPE_I2S, dev->idx) / 2 * 10 / config->bclk_freq_hz + 5) / 10;
    div = (div) ? (div - 1) : 0;
...
{
#ifdef romapi_qcc74x_i2s_deinit
    romapi_qcc74x_i2s_deinit(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
void qcc74x_i2s_link_txdma(struct qcc74x_device_s *dev, bool enable)
{
#ifdef romapi_qcc74x_i2s_link_txdma
    romapi_qcc74x_i2s_link_txdma(dev, enable);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_i2s_link_rxdma(struct qcc74x_device_s *dev, bool enable)
{
#ifdef romapi_qcc74x_i2s_link_rxdma
    romapi_qcc74x_i2s_link_rxdma(dev, enable);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_i2s_txint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_i2s_txint_mask
    romapi_qcc74x_i2s_txint_mask(dev, mask);
#else
    uint32_t regval;
...
void qcc74x_i2s_rxint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_i2s_rxint_mask
    romapi_qcc74x_i2s_rxint_mask(dev, mask);
#else
    uint32_t regval;
    uint32_t reg_base = dev->reg_base;
...
void qcc74x_i2s_errint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_i2s_errint_mask
    romapi_qcc74x_i2s_errint_mask(dev, mask);
#else
    uint32_t regval;
    uint32_t reg_base = dev->reg_base;
...
{
#ifdef romapi_qcc74x_i2s_get_intstatus
    return romapi_qcc74x_i2s_get_intstatus(dev);
#else
    uint32_t reg_base;
    uint32_t int_status;
    uint32_t int_mask;
...
{
#ifdef romapi_qcc74x_i2s_feature_control
    return romapi_qcc74x_i2s_feature_control(dev, cmd, arg);
#else
    int ret = 0;
    uint32_t reg_base;
    uint32_t regval;
