#ifndef _QCC74x_SFLASH_H
#define _QCC74x_SFLASH_H
 ...
 *  @{
 */
#define QCC74x_SPIFLASH_BLK32K_SIZE (32 * 1024)
#define QCC74x_SPIFLASH_BLK64K_SIZE (64 * 1024)
#define QCC74x_SPIFLASH_CMD_INVALID 0xff
