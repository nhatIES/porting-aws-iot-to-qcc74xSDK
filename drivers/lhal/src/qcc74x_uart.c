...
void qcc74x_uart_init(struct qcc74x_device_s *dev, const struct qcc74x_uart_config_s *config)
{
...
#ifdef romapi_qcc74x_uart_init
    romapi_qcc74x_uart_init(dev, config);
#else
    uint32_t div = 0;
    uint32_t tx_cfg;
    uint32_t rx_cfg;
    ...
    div = (qcc74x_clk_get_peripheral_clock(QCC74x_DEVICE_TYPE_UART, dev->idx) * 10 / config->baudrate + 5) / 10;
...
{
#ifdef romapi_qcc74x_uart_deinit
    romapi_qcc74x_uart_deinit(dev);
#else
    uint32_t reg_base;
    uint32_t tx_cfg;
    uint32_t rx_cfg;
...
{
#ifdef romapi_qcc74x_uart_enable
    romapi_qcc74x_uart_enable(dev);
#else
    uint32_t reg_base;
    uint32_t tx_cfg;
    uint32_t rx_cfg;
...
{
#ifdef romapi_qcc74x_uart_disable
    romapi_qcc74x_uart_disable(dev);
#else
    uint32_t reg_base;
    uint32_t tx_cfg;
    uint32_t rx_cfg;
...
void qcc74x_uart_link_txdma(struct qcc74x_device_s *dev, bool enable)
{
#ifdef romapi_qcc74x_uart_link_txdma
    romapi_qcc74x_uart_link_txdma(dev, enable);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_uart_link_rxdma(struct qcc74x_device_s *dev, bool enable)
{
#ifdef romapi_qcc74x_uart_link_rxdma
    romapi_qcc74x_uart_link_rxdma(dev, enable);
#else
    uint32_t reg_base;
    uint32_t regval;
...
ATTR_TCM_SECTION int qcc74x_uart_putchar(struct qcc74x_device_s *dev, int ch)
{
#ifdef romapi_qcc74x_uart_putchar
    return romapi_qcc74x_uart_putchar(dev, ch);
#else
    uint64_t start_time;
    uint32_t reg_base;
...
ATTR_TCM_SECTION int qcc74x_uart_getchar(struct qcc74x_device_s *dev)
{
#ifdef romapi_qcc74x_uart_getchar
    return romapi_qcc74x_uart_getchar(dev);
#else
    int ch = -1;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_uart_get
    return romapi_qcc74x_uart_get(dev, data, len);
#else
    int ch = -1;
    uint32_t count = 0;
...
{
#ifdef romapi_qcc74x_uart_txready
    return romapi_qcc74x_uart_txready(dev);
#else
    uint32_t reg_base;
...
bool qcc74x_uart_txempty(struct qcc74x_device_s *dev)
{
#ifdef romapi_qcc74x_uart_txempty
    return romapi_qcc74x_uart_txempty(dev);
#else
    uint32_t reg_base;
...
bool qcc74x_uart_rxavailable(struct qcc74x_device_s *dev)
{
#ifdef romapi_qcc74x_uart_rxavailable
    return romapi_qcc74x_uart_rxavailable(dev);
#else
    uint32_t reg_base;
...
void qcc74x_uart_txint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_uart_txint_mask
    romapi_qcc74x_uart_txint_mask(dev, mask);
#else
    uint32_t reg_base;
    uint32_t int_mask;
...
void qcc74x_uart_rxint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_uart_rxint_mask
    romapi_qcc74x_uart_rxint_mask(dev, mask);
#else
    uint32_t reg_base;
    uint32_t int_mask;
...
void qcc74x_uart_errint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_uart_errint_mask
    romapi_qcc74x_uart_errint_mask(dev, mask);
#else
    uint32_t reg_base;
    uint32_t int_mask;
...
{
#ifdef romapi_qcc74x_uart_get_intstatus
    return romapi_qcc74x_uart_get_intstatus(dev);
#else
    uint32_t reg_base;
    uint32_t int_status;
    uint32_t int_mask;
...
{
#ifdef romapi_qcc74x_uart_int_clear
    romapi_qcc74x_uart_int_clear(dev, int_clear);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_uart_feature_control
    return romapi_qcc74x_uart_feature_control(dev, cmd, arg);
#else
    int ret = 0;
    uint32_t reg_base;
    uint32_t tmp;
    ...
    switch (cmd) {
        case UART_CMD_SET_BAUD_RATE:
            ...
            /* Cal the baud rate divisor */
            tmp = (qcc74x_clk_get_peripheral_clock(QCC74x_DEVICE_TYPE_UART, dev->idx) * 10 / arg + 5) / 10;
