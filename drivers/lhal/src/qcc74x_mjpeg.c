...
#ifdef romapi_qcc74x_mjpeg_init
    romapi_qcc74x_mjpeg_init(dev, config);
#else
    uint32_t regval;
    uint32_t reg_base;
    uint16_t blocks;
...
{
#ifdef romapi_qcc74x_mjpeg_start
    romapi_qcc74x_mjpeg_start(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_stop
    romapi_qcc74x_mjpeg_stop(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_sw_run
    romapi_qcc74x_mjpeg_sw_run(dev, frame_count);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_kick_run
    romapi_qcc74x_mjpeg_kick_run(dev, kick_count);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_kick_stop
    romapi_qcc74x_mjpeg_kick_stop(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_kick
    romapi_qcc74x_mjpeg_kick(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
void qcc74x_mjpeg_tcint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_mjpeg_tcint_mask
    romapi_qcc74x_mjpeg_tcint_mask(dev, mask);
#else
    uint32_t regval;
    uint32_t reg_base;
...
void qcc74x_mjpeg_errint_mask(struct qcc74x_device_s *dev, bool mask)
{
    ...
    romapi_qcc74x_mjpeg_errint_mask(dev, mask);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_get_intstatus
    return romapi_qcc74x_mjpeg_get_intstatus(dev);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_get_frame_count
    return romapi_qcc74x_mjpeg_get_frame_count(dev);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_pop_one_frame
    romapi_qcc74x_mjpeg_pop_one_frame(dev);
#else
    uint32_t reg_base;
...
uint32_t qcc74x_mjpeg_get_frame_info(struct qcc74x_device_s *dev, uint8_t **pic)
{
    ...
    return romapi_qcc74x_mjpeg_get_frame_info(dev, pic);
#else
    uint32_t bytes;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_fill_quantize_table
    romapi_qcc74x_mjpeg_fill_quantize_table(dev, input_yy, input_uv);
#else
...
{
#ifdef romapi_qcc74x_mjpeg_fill_jpeg_header_tail
    romapi_qcc74x_mjpeg_fill_jpeg_header_tail(dev, header, header_len);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_set_yuv420sp_cam_input
    romapi_qcc74x_mjpeg_set_yuv420sp_cam_input(dev, yy, uv);
#else
    uint32_t regval;
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_update_input_output_buff
    romapi_qcc74x_mjpeg_update_input_output_buff(dev, input_buf0, input_buf1, output_buff, output_buff_size);
#else
    uint32_t reg_base;
...
{
#ifdef romapi_qcc74x_mjpeg_feature_control
