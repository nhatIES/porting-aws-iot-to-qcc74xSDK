...
{
#ifdef romapi_qcc74x_wo_pin_init
    romapi_qcc74x_wo_pin_init(dev, pin, mode);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_init
    romapi_qcc74x_wo_init(dev, cfg);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_enable
    romapi_qcc74x_wo_enable(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_disable
    romapi_qcc74x_wo_disable(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_get_fifo_available_cnt
    return romapi_qcc74x_wo_get_fifo_available_cnt(dev);
#else
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_push_fifo
    return romapi_qcc74x_wo_push_fifo(dev, data, len);
#else
    uint32_t idx = 0;
    uint32_t fclk = qcc74x_clk_get_system_clock(QCC74x_SYSTEM_CPU_CLK);
    uint32_t xclk = qcc74x_clk_get_system_clock(QCC74x_SYSTEM_XCLK);
...
{
#ifdef romapi_qcc74x_wo_clear_fifo
    romapi_qcc74x_wo_clear_fifo(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_enable_dma
    romapi_qcc74x_wo_enable_dma(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_disable_dma
    romapi_qcc74x_wo_disable_dma(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_get_int_status
    return romapi_qcc74x_wo_get_int_status(dev);
#else
    uint32_t regval;
    uint32_t sts = 0;
...
{
#ifdef romapi_qcc74x_wo_int_mask
    romapi_qcc74x_wo_int_mask(dev, int_type);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_int_unmask
    romapi_qcc74x_wo_int_unmask(dev, int_type);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_wo_int_clear
    romapi_qcc74x_wo_int_clear(dev, int_type);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_wo_uart_init(struct qcc74x_device_s *dev, uint32_t baudrate, uint8_t pin)
{
    ...
    baudrate = qcc74x_clk_get_system_clock(QCC74x_SYSTEM_XCLK) / baudrate;
