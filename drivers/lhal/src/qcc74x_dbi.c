...
#ifdef romapi_qcc74x_dbi_init
    romapi_qcc74x_dbi_init(dev, config);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_deinit
    romapi_qcc74x_dbi_deinit(dev);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_qspi_set_addr
    romapi_qcc74x_dbi_qspi_set_addr(dev, addr_byte_size, addr_val);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_send_cmd_data
    return romapi_qcc74x_dbi_send_cmd_data(dev, cmd, data_len, data_buff);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_send_cmd_read_data
    return romapi_qcc74x_dbi_send_cmd_read_data(dev, cmd, data_len, data_buff);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_send_cmd_pixel
    return romapi_qcc74x_dbi_send_cmd_pixel(dev, cmd, pixel_cnt, pixel_buff);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_dbi_link_txdma(struct qcc74x_device_s *dev, bool enable)
{
#ifdef romapi_qcc74x_dbi_link_txdma
    romapi_qcc74x_dbi_link_txdma(dev, enable);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_dbi_txint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_dbi_txint_mask
    romapi_qcc74x_dbi_txint_mask(dev, mask);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_dbi_tcint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_dbi_tcint_mask
    romapi_qcc74x_dbi_tcint_mask(dev, mask);
#else
    uint32_t reg_base;
    uint32_t regval;
...
void qcc74x_dbi_errint_mask(struct qcc74x_device_s *dev, bool mask)
{
#ifdef romapi_qcc74x_dbi_errint_mask
    romapi_qcc74x_dbi_errint_mask(dev, mask);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_int_clear
    romapi_qcc74x_dbi_int_clear(dev, int_clear);
#else
    uint32_t reg_base;
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_dbi_feature_control
    return romapi_qcc74x_dbi_feature_control(dev, cmd, arg);
#else
    int ret = 0;
    uint32_t reg_base;
    uint32_t regval;
