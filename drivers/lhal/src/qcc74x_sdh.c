...
#ifdef romapi_qcc74x_sdh_init
    return romapi_qcc74x_sdh_init(dev, cfg);
#else
    uint32_t reg_base;
    uint32_t regval;
...
#ifdef romapi_qcc74x_sdh_adma2_desc_init
    return romapi_qcc74x_sdh_adma2_desc_init(dev, data_cfg);
#else
    struct qcc74x_sdh_data_tranfer_s *curr_tranfer = NULL;
    struct qcc74x_sdh_adma2_hw_desc_s *curr_hw_desc = NULL;
...
#ifdef romapi_qcc74x_sdh_cmd_cfg
    return romapi_qcc74x_sdh_cmd_cfg(dev, cmd_cfg);
#else
    uint32_t reg_base;
    uint32_t regval;
...
#ifdef romapi_qcc74x_sdh_data_cfg
    return romapi_qcc74x_sdh_data_cfg(dev, data_cfg);
#else
    uint32_t reg_base;
    uint32_t regval;
...
#ifdef romapi_qcc74x_sdh_tranfer_start
    return romapi_qcc74x_sdh_tranfer_start(dev, cmd_cfg, data_cfg);
#else
    int ret;
    uint32_t reg_base;
...
#ifdef romapi_qcc74x_sdh_get_resp
    return romapi_qcc74x_sdh_get_resp(dev, cmd_cfg);
#else
    uint32_t reg_base;
    reg_base = dev->reg_base;
...
void qcc74x_sdh_sta_en(struct qcc74x_device_s *dev, uint32_t sta_bit, bool en)
{
#ifdef romapi_qcc74x_sdh_sta_en
    romapi_qcc74x_sdh_sta_en(dev, sta_bit, en);
#else
    uint32_t regval;
...
{
#ifdef romapi_qcc74x_sdh_sta_en_get
    return romapi_qcc74x_sdh_sta_en_get(dev);
#else
    uint32_t regval;
    uint32_t reg_base = dev->reg_base;
    regval = getreg32(reg_base + SDH_NORMAL_INT_STATUS_EN_OFFSET);
...
void qcc74x_sdh_sta_int_en(struct qcc74x_device_s *dev, uint32_t sta_bit, bool en)
{
#ifdef romapi_qcc74x_sdh_sta_int_en
    romapi_qcc74x_sdh_sta_int_en(dev, sta_bit, en);
#else
    uint32_t regval;
    uint32_t reg_base = dev->reg_base;
...
{
#ifdef romapi_qcc74x_sdh_sta_int_en_get
    return romapi_qcc74x_sdh_sta_int_en_get(dev);
#else
    uint32_t regval;
    uint32_t reg_base = dev->reg_base;
    regval = getreg32(reg_base + SDH_NORMAL_INT_STATUS_INT_EN_OFFSET);
...
{
#ifdef romapi_qcc74x_sdh_sta_get
    return romapi_qcc74x_sdh_sta_get(dev);
#else
    uint32_t regval;
    uint32_t reg_base = dev->reg_base;
...
{
#ifdef romapi_qcc74x_sdh_sta_clr
    romapi_qcc74x_sdh_sta_clr(dev, sta_bit);
#else
    uint32_t reg_base = dev->reg_base;
...
{
#ifdef romapi_qcc74x_sdh_feature_control
    return romapi_qcc74x_sdh_feature_control(dev, cmd, arg);
#else
    int ret = 0;
    uint32_t reg_base;
    uint32_t regval;
