#ifndef __QCC743_PSRAM_CTRL_H__
#define __QCC743_PSRAM_CTRL_H__
...
#define QCC743_PSRAM_GPIO41_REG_BASE 0x20000968
#define QCC743_PSRAM_GPIO_IE_MASK    0x01
#define QCC743_PSRAM_INIT_DONE       (                                                \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 0) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 1) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 2) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 3) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 4) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 5) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 6) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 7) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 8) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 9) & QCC743_PSRAM_GPIO_IE_MASK) &&  \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 10) & QCC743_PSRAM_GPIO_IE_MASK) && \
    (QCC74x_RD_WORD(QCC743_PSRAM_GPIO41_REG_BASE + 4 * 11) & QCC743_PSRAM_GPIO_IE_MASK))
...
typedef struct
{
    QCC74x_Fun_Type rst;                            /*!< Winbond pSRAM CR1 - Software Reset */
    PSRAM_Clock_Type clockType;                 /*!< Winbond pSRAM CR1 - Master Clock Type */
    QCC74x_Fun_Type inputPowerDownMode;             /*!< Winbond pSRAM CR1 - Input Power Down */
    QCC74x_Fun_Type linear_dis;                     /*!< Winbond pSRAM linear burst disable */
    QCC74x_Fun_Type hybridSleepMode;                /*!< Winbond pSRAM CR1 - Hybrid Sleep Mode configuration */
    PSRAM_Partial_Array_Refresh PASR;           /*!< Winbond pSRAM CR1 - Partial Array Refresh + Distributed Refresh Interval */
    QCC74x_Fun_Type disDeepPowerDownMode;           /*!< Winbond pSRAM CR0 - Deep Power-Down Disable configuration */
    QCC74x_Fun_Type fixedLatency;                   /*!< Winbond pSRAM CR1 - Fix Latency configuration */
...
typedef struct
{
    QCC74x_Fun_Type rst;                          /*!< AP Memory pSRAM configure global reset enable */
    QCC74x_Fun_Type fixedLatency;                 /*!< AP Memory pSRAM configure MR0 - read latency type */
    ...
    QCC74x_Fun_Type halfSleepModeEnable;          /*!< AP Memory pSRAM configure MR6 - Half Sleep enable */
    QCC74x_Fun_Type deepPowerDownModeEnable;      /*!< AP Memory pSRAM configure MR6 - Deep Power Down enable */
    QCC74x_Fun_Type crossBoundaryEnable;          /*!< AP Memory pSRAM configure MR8 - cross boundary enable 1'b0 - Read within 1K boundary 1'b1 -
