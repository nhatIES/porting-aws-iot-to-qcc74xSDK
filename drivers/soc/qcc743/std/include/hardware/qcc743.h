...
#endif
/**
 * @brief QCC743 Interrupt Number Definition, according to the selected device
...
#endif
#endif
    /******  QCC743 specific Interrupt Numbers **********************************************************************/
...
/**
 * @brief QCC743 Memory Map Definitions
 */
#define QCC743_OCRAM_BASE                     (0x20FC0000)
#define QCC743_OCRAM_END                      (0x20FC0000 + 320 * 1024)
#define QCC743_OCRAM_CACHEABLE_BASE           (0x60FC0000)
#define QCC743_OCRAM_CACHEABLE_END            (0x60FC0000 + 320 * 1024)
#define QCC743_OCRAM_BUSREMAP_BASE            (0x22FC0000)
#define QCC743_OCRAM_BUSREMAP_END             (0x22FC0000 + 320 * 1024)
#define QCC743_OCRAM_BUSREMAP_CACHEABLE_BASE  (0x62FC0000)
#define QCC743_OCRAM_BUSREMAP_CACHEABLE_END   (0x62FC0000 + 320 * 1024)

#define QCC743_WRAM_BASE                      (0x21010000)
#define QCC743_WRAM_END                       (0x21010000 + 160 * 1024)
#define QCC743_WRAM_CACHEABLE_BASE            (0x61010000)
#define QCC743_WRAM_CACHEABLE_END             (0x61010000 + 160 * 1024)
#define QCC743_WRAM_BUSREMAP_BASE             (0x23010000)
#define QCC743_WRAM_BUSREMAP_END              (0x23010000 + 160 * 1024)
#define QCC743_WRAM_BUSREMAP_CACHEABLE_BASE   (0x63010000)
#define QCC743_WRAM_BUSREMAP_CACHEABLE_END    (0x63010000 + 160 * 1024)

#define QCC743_FLASH_XIP_BASE                 (0xA0000000)
#define QCC743_FLASH_XIP_END                  (0xA0000000 + 64 * 1024 * 1024)
#define QCC743_FLASH_XIP_REMAP0_BASE          (0xD0000000)
#define QCC743_FLASH_XIP_REMAP0_END           (0xD0000000 + 64 * 1024 * 1024)
#define QCC743_FLASH_XIP_BUSREMAP_BASE        (0xA0000000)
#define QCC743_FLASH_XIP_BUSREMAP_END         (0xA0000000 + 64 * 1024 * 1024)

#define QCC743_FLASH2_XIP_BASE                (0x84000000)
#define QCC743_FLASH2_XIP_END                 (0x84000000 + 64 * 1024 * 1024)
#define QCC743_FLASH2_XIP_REMAP0_BASE         (0xD4000000)
#define QCC743_FLASH2_XIP_REMAP0_END          (0xD4000000 + 64 * 1024 * 1024)
#define QCC743_FLASH2_XIP_BUSREMAP_BASE       (0xA4000000)
#define QCC743_FLASH2_XIP_BUSREMAP_END        (0xA4000000 + 64 * 1024 * 1024)

#define QCC743_PSRAM_BASE                     (0x88000000)
#define QCC743_PSRAM_END                      (0x88000000 + 128 * 1024 * 1024)
#define QCC743_PSRAM_REMAP0_BASE              (0xD8000000)
#define QCC743_PSRAM_REMAP0_END               (0xD8000000 + 128 * 1024 * 1024)
#define QCC743_PSRAM_BUSREMAP_BASE            (0xA8000000)
#define QCC743_PSRAM_BUSREMAP_END             (0xA8000000 + 128 * 1024 * 1024)

#define QCC743_ALLRAM_BASE                    (0x20FC0000)
#define QCC743_ALLRAM_END                     (0x20FC0000 + 320 * 1024 + 160 * 1024)
#define QCC743_ALLRAM_CACHEABLE_BASE          (0x60FC0000)
#define QCC743_ALLRAM_CACHEABLE_END           (0x60FC0000 + 320 * 1024 + 160 * 1024)
#define QCC743_ALLRAM_BUSREMAP_BASE           (0x22FC0000)
#define QCC743_ALLRAM_BUSREMAP_END            (0x22FC0000 + 320 * 1024 + 160 * 1024)
#define QCC743_ALLRAM_BUSREMAP_CACHEABLE_BASE (0x62FC0000)
#define QCC743_ALLRAM_BUSREMAP_CACHEABLE_END  (0x62FC0000 + 320 * 1024 + 160 * 1024)

/*@} end of group Memory_Map_Section */

/* QCC743 peripherals base address */
/* WLSYS */
...
typedef enum {
    QCC74x_AHB_SLAVE1_GLB = 0x00,    //cgen rsvd
    QCC74x_AHB_SLAVE1_RF_TOP = 0x01, //swrst mix
    QCC74x_AHB_SLAVE1_GPIP = 0x02,
    QCC74x_AHB_SLAVE1_SEC_DBG = 0x03,
    QCC74x_AHB_SLAVE1_SEC_ENG = 0x04,
    QCC74x_AHB_SLAVE1_TZ = 0x05,    //swrst tz1,cgen tz1+tz2
    QCC74x_AHB_SLAVE1_RSVD6 = 0x06, //swrst tz2,
    QCC74x_AHB_SLAVE1_EF_CTRL = 0x07,
    QCC74x_AHB_SLAVE1_CCI = 0x08, //cgen rsvd
    QCC74x_AHB_SLAVE1_L1C = 0x09, //cgen rsvd
    QCC74x_AHB_SLAVE1_RSVD10 = 0x0A,
    QCC74x_AHB_SLAVE1_SF_CTRL = 0x0B,
    QCC74x_AHB_SLAVE1_DMA = 0x0C,
    QCC74x_AHB_SLAVE1_SDU = 0x0D, //cgen rsvd
    QCC74x_AHB_SLAVE1_PDS = 0x0E, //cgen rsvd
    ...
    QCC74x_AHB_SLAVE1_GPADC = 0x21, /* not used for cgen and swrst */
    QCC74x_AHB_SLAVE1_GPDAC = 0x22, /* not used for cgen and swrst */
    QCC74x_AHB_SLAVE1_I2S = 0x23,   /* not used for cgen and swrst */
    QCC74x_AHB_SLAVE1_CAM = 0x24,   /* not used for cgen and swrst */
