#ifndef __QCC743_SDH_H__
#define __QCC743_SDH_H__
...
typedef struct
{
    ...
    QCC74x_Fun_Type vlot18Enable;          /*!< SDH enable 1.8V */
    QCC74x_Fun_Type highSpeed;             /*!< SDH enable high speed */
...
typedef struct
{
    QCC74x_Fun_Type enableAutoCommand12; /*!< SDH enable auto CMD12 */
    QCC74x_Fun_Type enableAutoCommand23; /*!< SDH enable auto CMD23 */
    QCC74x_Fun_Type enableIgnoreError;   /*!< SDH enable to ignore error event to read/write all the data */
...
#define SDH_EnableIntStatus(mask)                                             \
    do {                                                                      \
        QCC74x_WR_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_EN,                      \
                  QCC74x_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_EN) | (mask)); \
    } while (0)
...
#define SDH_EnableIntSource(mask)                                                 \
    do {                                                                          \
        QCC74x_WR_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_INT_EN,                      \
                  QCC74x_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_INT_EN) | (mask)); \
    } while (0)
...
#define SDH_GetIntStatus()       QCC74x_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS);
#define SDH_GetIntEnableStatus() QCC74x_RD_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS_INT_EN);
#define SDH_ClearIntStatus(mask) QCC74x_WR_REG(SDH_BASE, SDH_SD_NORMAL_INT_STATUS, (mask));
#define SDH_AutoCmd12ErrStatus() QCC74x_RD_SHORT(SDH_BASE + SDH_SD_AUTO_CMD12_ERROR_STATUS_OFFSET);
#define SDH_GetDMAErrStatus()    QCC74x_RD_SHORT(SDH_BASE + SDH_SD_ADMA_ERROR_STATUS_OFFSET);
#define SDH_GetPresentStatus()   QCC74x_RD_REG(SDH_BASE, SDH_SD_PRESENT_STATE_1);
