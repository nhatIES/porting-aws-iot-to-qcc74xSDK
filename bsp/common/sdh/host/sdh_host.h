...
struct sdh_host_transfer_s {
    struct qcc74x_sdh_cmd_cfg_s *cmd_cfg;
    struct qcc74x_sdh_data_cfg_s *data_cfg;
};

struct sdh_host_s {
    /* lhal dev */
    struct qcc74x_device_s *sdh_dev;

    void *osal_semb; /* Binary Semaphore */

#if 0
    bool sbc_cmd_en; /* SET_BLOCK_COUNT for multiblock */
    struct qcc74x_sdh_cmd_cfg_s *sbc_cmd_cfg;
    bool stop_cmd_en; /* STOP_TRANSMISSION for multiblock */
    struct qcc74x_sdh_cmd_cfg_s *stop_cmd_cfg;
#endif
    void *internal_buff; /* Internal buffer (nocache) 512-byte */
    uint32_t internal_buff_size;

    /* adma descriptors buff */
    struct qcc74x_sdh_adma2_hw_desc_s *adma2_hw_desc; /*!< The address of adma2 hardware descriptors. */
