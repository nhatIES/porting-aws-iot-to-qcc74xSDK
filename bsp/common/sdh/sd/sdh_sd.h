...
struct sd_csd_s {
    ...
    uint8_t read_qcc74x_len;   /* Maximum read data block length [83:80] */

    uint8_t read_qcc74x_partial : 1; /*!< Partial blocks for read allowed [79:79] */
    ...
    uint8_t write_qcc74x_len       : 4; /*!< Maximum write data block length [25:22] */
    uint8_t write_qcc74x_partial   : 1; /*!< Partial blocks for write allowed [21:21] */
