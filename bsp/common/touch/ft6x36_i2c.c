...
static struct qcc74x_device_s *touch_ft6x36_i2c = NULL;

static void ft6x36_i2c_gpio_init(void)
{
    struct qcc74x_device_s *ft63x6_i2c_gpio = NULL;
    ft63x6_i2c_gpio = qcc74x_device_get_by_name("gpio");

    /* I2C0_SCL */
    qcc74x_gpio_init(ft63x6_i2c_gpio, TOUCH_I2C_SCL_PIN, GPIO_FUNC_I2C0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
    /* I2C0_SDA */
    qcc74x_gpio_init(ft63x6_i2c_gpio, TOUCH_I2C_SDA_PIN, GPIO_FUNC_I2C0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
}

static int ft6x36_i2c_peripheral_init(void)
{
    touch_ft6x36_i2c = qcc74x_device_get_by_name("i2c0");
    ...
    if (touch_ft6x36_i2c) {
        ...
        /* init i2c 200k */
        qcc74x_i2c_init(touch_ft6x36_i2c, 200000);
    } else {
...
static int ft6x36_i2c_read_byte(uint8_t register_addr, uint8_t *data_buf, uint16_t len)
{
    ...
    msg[1].length = len;
    qcc74x_i2c_transfer(touch_ft6x36_i2c, msg, 2);
