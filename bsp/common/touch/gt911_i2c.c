...
static struct qcc74x_device_s *touch_gt911_i2c = NULL;

static void gt911_i2c_gpio_init(void)
{
    struct qcc74x_device_s *gt911_i2c_gpio = NULL;
    gt911_i2c_gpio = qcc74x_device_get_by_name("gpio");

    /* I2C0_SCL */
    qcc74x_gpio_init(gt911_i2c_gpio, TOUCH_I2C_SCL_PIN /* GPIO_PIN_6 */, GPIO_FUNC_I2C0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
    /* I2C0_SDA */
    qcc74x_gpio_init(gt911_i2c_gpio, TOUCH_I2C_SDA_PIN /* GPIO_PIN_9 */, GPIO_FUNC_I2C0 | GPIO_ALTERNATE | GPIO_PULLUP | GPIO_SMT_EN | GPIO_DRV_2);
}

static int gt911_i2c_peripheral_init(void)
{
    touch_gt911_i2c = qcc74x_device_get_by_name("i2c0");
    ...
    if (touch_gt911_i2c) {
        ...
        gt911_i2c_gpio_init();
        /* init i2c 200k */
        qcc74x_i2c_init(touch_gt911_i2c, 200000);
    } else {
...
{
    static struct qcc74x_i2c_msg_s msg[2];
    ...
    msg[1].length = len;
    qcc74x_i2c_transfer(touch_gt911_i2c, msg, 2);
    return 0;
}
...
int gt911_i2c_init(touch_coord_t *max_value)
{
    ...
    product_id = QCC74x_RDWD_FRM_BYTEP(data_buf);
