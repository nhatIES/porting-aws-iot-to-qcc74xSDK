#ifndef _QCC74x_SPI_HARD_4_H
#define _QCC74x_SPI_HARD_4_H
...
#define LCD_SPI_HARD_4_CS_HIGH            qcc74x_gpio_set(gpio, LCD_SPI_HARD_4_PIN_CS)
#define LCD_SPI_HARD_4_CS_LOW             qcc74x_gpio_reset(gpio, LCD_SPI_HARD_4_PIN_CS)
#define LCD_SPI_HARD_4_DC_HIGH            qcc74x_gpio_set(gpio, LCD_SPI_HARD_4_PIN_DC)
#define LCD_SPI_HARD_4_DC_LOW             qcc74x_gpio_reset(gpio, LCD_SPI_HARD_4_PIN_DC)
