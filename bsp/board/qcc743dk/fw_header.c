...
# 3 : SF_CTRL_WRAP_LEN_64, 9 : SF_CTRL_WRAP_LEN_4096
    ...
    .cpu_cfg.cache_enable = 0x0,   /* cache setting :only for qcc74x Cache */
    .cpu_cfg.cache_wa = 0x0,       /* cache setting :only for qcc74x Cache*/
    .cpu_cfg.cache_wb = 0x0,       /* cache setting :only for qcc74x Cache*/
    .cpu_cfg.cache_wt = 0x0,       /* cache setting :only for qcc74x Cache*/
    .cpu_cfg.cache_way_dis = 0x0,  /* cache setting :only for qcc74x Cache*/
    .cpu_cfg.rsvd = 0x0,
