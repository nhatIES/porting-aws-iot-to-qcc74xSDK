...
get_filename_component(QCC74x_SDK_CMAKE_DIR ${QCC74x_SDK_BASE}/cmake/extension.cmake ABSOLUTE)
get_filename_component(QCC74x_SDK_CMAKE_DIR ${QCC74x_SDK_CMAKE_DIR} DIRECTORY)

if(VSCODE_DIR)
    set(VSCODE_DIR_ ${VSCODE_DIR}/.vscode)
else()
    set(VSCODE_DIR_ ${QCC74x_SDK_CMAKE_DIR}/../.vscode)
endif()

# may cause fails when multi-threading ci build
# configure_file(${QCC74x_SDK_BASE}/tools/vscode/c_cpp_properties.json ${VSCODE_DIR_}/c_cpp_properties.json)
